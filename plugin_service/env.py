...
PAASV3_APIGW_API_HOST = os.getenv("BKAPP_PAASV3_APIGW_API_HOST")
PLUGIN_APIGW_API_HOST_FORMAT = os.getenv(
    "BKAPP_PLUGIN_APIGW_API_HOST_FORMAT", f"{APIGW_NETWORK_PROTOCAL}://{{}}.{APIGW_URL_SUFFIX}"
)
