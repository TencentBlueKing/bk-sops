...
from gcloud.apigw.views.apply_job_file_upload_ticket import apply_job_file_upload_ticket
from gcloud.apigw.views.job_file_upload import job_file_upload
...
urlpatterns = [
    ...
    url(r"^apply_job_file_upload_ticket/$", apply_job_file_upload_ticket),
    url(r"^job_file_upload/(?P<project_id>\d+)/$", job_file_upload),
]
