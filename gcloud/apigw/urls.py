...
from gcloud.apigw.views.plugin_gateway import (
    ...
    plugin_gateway_run_internal_callback,
)
...
urlpatterns = [
    ...
    re_path(r"^plugin-gateway/categories/$", get_plugin_gateway_categories, name="apigw_plugin_gateway_categories"),
    re_path(r"^plugin-gateway/plugins/$", get_plugin_gateway_list, name="apigw_plugin_gateway_list"),
    re_path(
        r"^plugin-gateway/plugins/(?P<plugin_id>[\w-]+)/$",
        get_plugin_gateway_detail,
        name="apigw_plugin_gateway_detail",
    ),
    re_path(r"^plugin-gateway/runs/$", create_plugin_gateway_run, name="apigw_plugin_gateway_run_create"),
    re_path(
    ...
    re_path(r"^get_clocked_task_list/(?P<project_id>\d+)/$", get_clocked_task_list),
    ...
    re_path(r"^modify_template_notify/(?P<template_id>\d+)/(?P<project_id>\d+)/$", modify_template_notify),
    ...
    re_path(r"^get_task_node_log/(?P<task_id>\d+)/(?P<project_id>\d+)/$", get_task_node_log),
    re_path(r"^get_task_plugin_log/(?P<task_id>\d+)/(?P<project_id>\d+)/$", get_task_plugin_log),
