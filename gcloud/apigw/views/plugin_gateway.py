...
def get_plugin_gateway_categories(request):
    return {
        "result": True,
        "data": PluginGatewayCatalogService.get_categories(plugin_source=request.GET.get("plugin_source")),
...
def plugin_gateway_run_internal_callback(request, run_id):
    ...
    callback_plugin_gateway_run.apply_async(
        kwargs={"open_plugin_run_id": run_id, "callback_data": raw_payload.get("callback_data")},
