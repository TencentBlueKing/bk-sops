                ...
                try:
                    if special_business_id and special_tenant_id:
                        if model.__name__ == "Business":
                            model.objects.filter(cc_id__in=special_business_id).update(tenant_id=special_tenant_id)
                        elif model.__name__ == "Project":
                            model.objects.filter(bk_biz_id__in=special_business_id).update(tenant_id=special_tenant_id)
                    else:
