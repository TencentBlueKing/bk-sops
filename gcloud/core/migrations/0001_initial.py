    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("business", models.ForeignKey(to="core.Business", on_delete=models.CASCADE)),
        ...
        migrations.AlterUniqueTogether(name="businessgroupmembership", unique_together=set([("business", "group")]),),
    ]
