        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "template_id",
                    models.CharField(
                        max_length=255, verbose_name="\u521b\u5efa\u4efb\u52a1\u6240\u7528\u7684\u6a21\u677fID"
                    ),
                ),
                (
                    "business",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "history",
                    models.ForeignKey(
                        verbose_name="pipeline \u5c42\u5468\u671f\u4efb\u52a1\u5386\u53f2",
                        to="periodic_task.PeriodicTaskHistory",
                        on_delete=models.CASCADE,
                    ),
                ),
                (
