...
class ClockedTaskSerializer(serializers.ModelSerializer):
    ...
    notify_type_obj = ReadWriteSerializerMethodField(help_text="计划任务事件通知方式", required=False)
    notify_receivers_obj = ReadWriteSerializerMethodField(help_text="计划任务事件通知人", required=False)
