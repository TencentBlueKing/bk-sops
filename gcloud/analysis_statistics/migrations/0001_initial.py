    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_id', models.IntegerField(db_index=True, default=-1, help_text='模板所属project id', verbose_name='项目 ID')),
                ('instance_create_time', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Pipeline实例创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('OpsTools', '运维工具'), ('MonitorAlarm', '监控告警'), ('ConfManage', '配置管理'), ('DevTools', '开发工具'), ('EnterpriseIT', '企业IT'), ('OfficeApp', '办公应用'), ('Other', '其它'), ('Default', '默认分类')], default='Default', max_length=255, verbose_name='模板类型')),
                ...
                ('create_method', models.CharField(choices=[('app', '手动'), ('api', 'API网关'), ('app_maker', '轻应用'), ('periodic', '周期任务'), ('mobile', '移动端')], default='app', max_length=30, verbose_name='实例创建方式')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_create_time', models.DateTimeField(auto_now_add=True, db_index=True, null=True, verbose_name='创建时间')),
                ('template_edit_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='最近编辑时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(default='legacy', max_length=255, verbose_name='插件版本')),
                ('template_creator', models.CharField(blank=True, max_length=255, null=True, verbose_name='创建者')),
                ('template_create_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='模版创建时间')),
                ('template_edit_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='模板最近编辑时间')),
            ],
            options={
