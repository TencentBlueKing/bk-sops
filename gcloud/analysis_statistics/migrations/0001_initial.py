# Generated by Django 2.2.16 on 2021-08-25 12:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("instance_id", models.CharField(db_index=True, max_length=32, verbose_name="Pipeline实例ID")),
                ("task_instance_id", models.CharField(db_index=True, max_length=32, verbose_name="Task实例ID")),
                ...
                (
                    ...
                    models.DateTimeField(auto_now_add=True, db_index=True, verbose_name="Pipeline实例创建时间"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("instance_id", models.CharField(db_index=True, max_length=255, verbose_name="Pipeline实例ID")),
                ("task_instance_id", models.CharField(db_index=True, max_length=255, verbose_name="Task实例ID")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("template_create_time", models.DateTimeField(auto_now_add=True, null=True, verbose_name="创建时间")),
