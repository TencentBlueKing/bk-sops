...
drf_router.register(r"function_task", FunctionTaskViewSet, basename="function_task")
drf_router.register(r"variable", VariableViewSet)
drf_router.register(r"template", TaskTemplateViewSet, basename="template")
...
drf_router.register(r"taskflow", TaskFlowInstanceViewSet, basename="taskflow")
...
v4_drf_router.register(
    r"user_custom_config/(?P<project_id>-?\d+)", UserCustomConfViewset, basename="user_custom_config"
)
v4_drf_router.register(
