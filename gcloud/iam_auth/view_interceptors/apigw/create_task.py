    ...
    def process(self, request, *args, **kwargs):
        ...
        if template_source in NON_COMMON_TEMPLATE_TYPES:
            ...
            PermissionService().require(
                ...
                tenant_id,
                PermissionCheck(IAMMeta.FLOW_CREATE_TASK_ACTION, flow),
            )
        else:
            ...
            PermissionService().require_all(
                ...
                tenant_id,
                [
                    PermissionCheck(IAMMeta.COMMON_FLOW_CREATE_TASK_ACTION, common_flow),
                    PermissionCheck(IAMMeta.PROJECT_COMMON_CREATE_TASK_ACTION, project),
                ],
            )
