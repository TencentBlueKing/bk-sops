...
# 直接把 pytz 时区对象塞进 tzinfo 会拿到 LMT 偏移（Asia/Shanghai 为 +0806），
# 且该值随 tzdata 版本漂移，必须用 localize 得到稳定的 +0800。
...
TEST_CLOCKED_TASK_LIST = [
    {
        ...
        "editor": "editor1",
        "state": "started",
        "plan_start_time": SHANGHAI_TZ.localize(datetime(2026, 4, 17, 10, 0, 0)),
        "create_time": SHANGHAI_TZ.localize(datetime(2026, 4, 17, 9, 0, 0)),
        "edit_time": SHANGHAI_TZ.localize(datetime(2026, 4, 17, 9, 30, 0)),
    ...
    },
    {
        ...
        "editor": "editor2",
        "state": "finished",
        "plan_start_time": SHANGHAI_TZ.localize(datetime(2026, 4, 17, 11, 0, 0)),
        "create_time": SHANGHAI_TZ.localize(datetime(2026, 4, 17, 9, 30, 0)),
        "edit_time": SHANGHAI_TZ.localize(datetime(2026, 4, 17, 10, 0, 0)),
    ...
    def test_get_clocked_task_list__success(self):
        ...
        with mock.patch(CLOCKED_TASK_FILTER, MagicMock(return_value=clocked_tasks)):
            with mock.patch(
                ...
                with mock.patch(MOCK_GET_FLOW_ALLOWED_ACTIONS, MagicMock(return_value=TEST_TEMPLATE_VIEW_ACTIONS)):
