    ...
    def test_batch_create_strategy(self):
        pipeline_tree = {
            "activities": {
                ...
                "a2": {"type": "ServiceActivity", "auto_retry": {"enable": True, "times": 12}},
                ...
                "s1": {
                    ...
                    "pipeline": {
                        "activities": {
                            ...
                            "a5": {"type": "ServiceActivity", "auto_retry": {"enable": True, "times": 20}},
        ...
        self.assertEqual(
            strategies_map["a1"],
            {"taskflow_id": 1, "root_pipeline_id": "root", "node_id": "a1", "retry_times": 0, "max_retry_times": 2},
        )
        self.assertEqual(
            strategies_map["a2"],
            {"taskflow_id": 1, "root_pipeline_id": "root", "node_id": "a2", "retry_times": 0, "max_retry_times": 10},
        )
        self.assertEqual(
            strategies_map["a4"],
            {"taskflow_id": 1, "root_pipeline_id": "root", "node_id": "a4", "retry_times": 0, "max_retry_times": 1},
        )
        self.assertEqual(
            strategies_map["a5"],
            {"taskflow_id": 1, "root_pipeline_id": "root", "node_id": "a5", "retry_times": 0, "max_retry_times": 10},
        )
