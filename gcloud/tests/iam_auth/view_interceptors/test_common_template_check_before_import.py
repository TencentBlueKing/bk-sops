...
GET_IAM_CLIENT = "gcloud.iam_auth.view_interceptors.common_template.get_iam_client"
TENANT_ID = "default"
...
class CheckBeforeImportInterceptorTest(TestCase):
    ...
    def setUp(self):
        ...
        self.request = SimpleNamespace(user=SimpleNamespace(username="tester", tenant_id=TENANT_ID))
