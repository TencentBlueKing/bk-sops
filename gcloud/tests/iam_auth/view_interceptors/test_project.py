...
GET_IAM_CLIENT_PATH = "gcloud.iam_auth.view_interceptors.project.get_iam_client"
TENANT_ID = "default"


class ProjectInterceptorTestCase(TestCase):
    def setUp(self):
        self.request = SimpleNamespace(user=SimpleNamespace(username="tester", tenant_id=TENANT_ID), GET={}, POST={})
        patcher = mock.patch(GET_IAM_CLIENT_PATH)
        self.mocked_get_iam_client = patcher.start()
    ...
    def test_project_view__uses_kwargs_project_id_and_project_view_action(
        ...
        mocked_resources_for_project.assert_called_once_with(42, TENANT_ID)
    ...
    def test_project_flow_create__uses_flow_create_action(self, mocked_allow_or_raise, mocked_resources_for_project):
        ...
        mocked_resources_for_project.assert_called_once_with(7, TENANT_ID)
        mocked_allow_or_raise.assert_called_once()
        kwargs = mocked_allow_or_raise.call_args[1]
    ...
    def test_project_view__fallback_to_query_params_when_kwargs_missing(
        ...
        request = SimpleNamespace(
            user=SimpleNamespace(username="tester", tenant_id=TENANT_ID),
            GET={"project_id": "9"},
            POST={},
        )
        ...
        mocked_resources_for_project.assert_called_once_with("9", TENANT_ID)
        mocked_allow_or_raise.assert_called_once()
    ...
    def test_project_view__fallback_to_post_body_when_query_missing(
        ...
        mocked_resources_for_project.assert_called_once_with("11", TENANT_ID)
        mocked_allow_or_raise.assert_called_once()
    ...
    def test_project_view__kwargs_project_id_takes_precedence(
        ...
        mocked_resources_for_project.assert_called_once_with(1, TENANT_ID)
    ...
    def test_project_view__nonexistent_project_raises_auth_failed_not_500(
        ...
        mocked_resources_for_project.assert_called_once_with(999999, TENANT_ID)
        mocked_allow_or_raise.assert_not_called()
