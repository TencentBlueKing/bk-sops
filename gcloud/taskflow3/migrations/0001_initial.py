    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(default='Other', max_length=255, verbose_name='\u4efb\u52a1\u7c7b\u578b\uff0c\u7ee7\u627f\u81ea\u6a21\u677f', choices=[(b'OpsTools', '\u8fd0\u7ef4\u5de5\u5177'), (b'MonitorAlarm', '\u76d1\u63a7\u544a\u8b66'), (b'ConfManage', '\u914d\u7f6e\u7ba1\u7406'), (b'DevTools', '\u5f00\u53d1\u5de5\u5177'), (b'EnterpriseIT', '\u4f01\u4e1aIT'), (b'OfficeApp', '\u529e\u516c\u5e94\u7528'), (b'Other', '\u5176\u5b83')])),
                ('template_id', models.CharField(max_length=255, verbose_name='\u521b\u5efa\u4efb\u52a1\u6240\u7528\u7684\u6a21\u677fID')),
                ('create_method', models.CharField(default='app', max_length=30, verbose_name='\u521b\u5efa\u65b9\u5f0f', choices=[(b'app', 'APP'), (b'api', 'API'), (b'app_maker', 'App_maker')])),
                ('create_info', models.CharField(max_length=255, verbose_name='\u521b\u5efa\u4efb\u52a1\u989d\u5916\u4fe1\u606f\uff08App maker ID\u6216\u8005APP CODE\uff09', blank=True)),
                ('flow_type', models.CharField(default='common', max_length=255, verbose_name='\u4efb\u52a1\u6d41\u7a0b\u7c7b\u578b', choices=[(b'common', '\u9ed8\u8ba4\u4efb\u52a1\u6d41\u7a0b'), (b'common_func', '\u804c\u80fd\u5316\u4efb\u52a1\u6d41\u7a0b')])),
