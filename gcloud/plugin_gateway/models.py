...
class PluginGatewaySourceConfig(models.Model):
    ...
    execution_timeout_seconds = models.IntegerField(default=7200)
...
class PluginGatewayRun(models.Model):
    ...
    runtime_outputs = models.JSONField(default=dict, blank=True)
    schedule_times = models.IntegerField(default=0)
    execution_expire_at = models.DateTimeField(null=True, blank=True)
