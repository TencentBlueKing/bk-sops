...
class PackageSourceResource(Resource):
    ...
    base_source_id = fields.IntegerField(attribute="base_source_id", null=True)
    details = fields.DictField(attribute="details", readonly=True)
    imported_plugins = fields.ListField(attribute="imported_plugins", readonly=True, null=True)
...
class SyncTaskResource(GCloudModelResource):
    ...
    status_display = fields.CharField(attribute="status_display", readonly=True)
