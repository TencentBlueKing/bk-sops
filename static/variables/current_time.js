...
(function () {
    $.atoms.current_time = [
        {
            tag_code: "current_time",
            type: "combine",
            attrs: {
                name: gettext("系统当前时间格式"),
                hookable: true,
                children: [
                    {
                        tag_code: "time_unit",
                        ...
                        attrs: {
                            items: [
                                ...
                                {name: gettext("日"), value: "day"},
                                {name: gettext("时"), value: "hour"},
                                {name: gettext("分"), value: "minute"},
                                {name: gettext("秒"), value: "second"},
                            ],
                            ...
                            validation: [
                                {
                                    ...
                                    args: function (value) {
                                        ...
                                        if (value && !(value.length > 0)) {
                                            result.result = false;
                                            result.error_message = gettext("请至少选择一种单位格式");
                                        }
                                        return result;
                                    }
                                }
