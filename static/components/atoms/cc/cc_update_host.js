    ...
    $.atoms.cc_update_host = [
        ...
        },
        {
            ...
            attrs: {
                ...
                remote: true,
                remote_url: function () {
                    url = $.context.canSelectBiz() ? $.context.get('site_url') + 'pipeline/cc_search_object_attribute/host/' + $.context.get('bk_biz_id') + '/' : '';
                    return url
                },
                remote_data_init: function (resp) {
                    return resp.data;
            ...
            events: [
                {
                    ...
                    action: function () {
                        ...
                        this.items = [];
                        if (cc_id !== '') {
                            this.remote_url = $.context.get('site_url') + 'pipeline/cc_search_object_attribute/host/' + cc_id + '/';
                            this.remoteMethod();
                        }
                    }
                },
                {
                    ...
                    action: function (value) {
                        ...
                        this.items = [];
                        if (value !== '') {
                            this.remote_url = $.context.get('site_url') + 'pipeline/cc_search_object_attribute/host/' + value + '/';
                            this.remoteMethod();
                        }
                    }
                }
