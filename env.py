...
SYNC_INCREMENTAL_DATA_SWITCH = bool(os.getenv("SYNC_INCREMENTAL_DATA_SWITCH", False))

SYNC_INCREMENTAL_BATCH_SIZE = int(os.getenv("SYNC_INCREMENTAL_BATCH_SIZE", 100))
SYNC_INCREMENTAL_DATA_CRON = tuple(os.getenv("SYNC_INCREMENTAL_DATA_CRON", "30/* * * * *").split())

SYNC_SOURCE_HOST = os.getenv("SYNC_SOURCE_HOST")
SYNC_SOURCE_PORT = int(os.getenv("SYNC_SOURCE_PORT"))
SYNC_SOURCE_USER = os.getenv("SYNC_SOURCE_USER")
SYNC_SOURCE_PASSWORD = os.getenv("SYNC_SOURCE_PASSWORD")
SYNC_SOURCE_DATABASE = os.getenv("SYNC_SOURCE_DATABASE")
