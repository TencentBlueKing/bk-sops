...
ENABLE_CALLBACK_RETRY_TASK = bool(os.getenv("BKAPP_ENABLE_CALLBACK_RETRY_TASK", False))
CALLBACK_RETRY_CRON = tuple(os.getenv("BKAPP_CALLBACK_RETRY_CRON", "*/10 * * * *").split())
MAX_CALLBACK_RETRY_TIMES = int(os.getenv("BKAPP_MAX_CALLBACK_RETRY_TIMES", 3))