...
ENABLE_CLEAN_EXPIRED_TASKS = bool(os.getenv("BKAPP_ENABLE_CLEAN_EXPIRED_TASKS", False))
CLEAN_EXPIRED_TASK_DATA_CRON = tuple(os.getenv("BKAPP_CLEAN_EXPIRED_TASK_DATA_CRON", "30 0 * * *").split())
CLEAN_EXPIRED_TASK_BATCH_NUM = int(os.getenv("BKAPP_CLEAN_EXPIRED_TASK_BATCH_NUM", 100))
CLEAN_TASK_MAX_ID = int(os.getenv("BKAPP_CLEAN_TASK_MAX_ID", 10000))
