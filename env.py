...
APIGW_AI_PLATFORM_HEADER = os.getenv("APIGW_AI_PLATFORM_HEADER", "HTTP_X_BKAPI_AI_PLATFORM")

# APIGW AI 技能名称 HTTP Header 配置
APIGW_AI_SKILL_HEADER = os.getenv("APIGW_AI_SKILL_HEADER", "HTTP_X_BKAPI_AI_SKILL")
