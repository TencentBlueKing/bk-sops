...
# 第三方插件调用超时时间
REMOTE_PLUGIN_INVOKE_TIMEOUT = int(os.getenv("BKAPP_REMOTE_PLUGIN_INVOKE_TIMEOUT", 600))
REMOTE_PLUGIN_DETAIL_TIMEOUT = int(os.getenv("BKAPP_REMOTE_PLUGIN_DETAIL_TIMEOUT", 300))
REMOTE_PLUGIN_SCHEDULE_TIMEOUT = int(os.getenv("BKAPP_REMOTE_PLUGIN_SCHEDULE_TIMEOUT", 300))
