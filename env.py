...
ARCHIVED_EXPIRED_V2_TASK_CRON = tuple(os.getenv("BKAPP_ARCHIVED_EXPIRED_V2_TASK_CRON", "30 0 * * *").split())
ARCHIVED_EXPIRED_V2_TASK_BATCH_NUM = int(os.getenv("BKAPP_ARCHIVED_EXPIRED_V2_TASK_BATCH_NUM", 100))
