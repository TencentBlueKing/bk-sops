...
# 流程编排助手配置
AGENT_PROCESS_BUILD_URL = os.getenv("AGENT_PROCESS_BUILD_URL", "")
AGENT_PROCESS_BUILD_CODE = os.getenv("AGENT_PROCESS_BUILD_CODE", "")
AGENT_PROCESS_BUILD_TOKEN = os.getenv("AGENT_PROCESS_BUILD_TOKEN", "")
