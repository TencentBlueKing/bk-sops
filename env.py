...
IS_PAAS_V3 = int(os.getenv("BKPAAS_MAJOR_VERSION", 2)) == 3
IS_OPEN_V3 = IS_PAAS_V3 and RUN_VER == "open"
PAAS_MAJOR_VERSION = int(os.getenv("BKPAAS_MAJOR_VERSION", 2))
...
# IAM SEARCH ENGINE 地址
BK_IAM_SEARCH_ENGINE_HOST = os.getenv("BKAPP_IAM_SEARCH_ENGINE_HOST")
