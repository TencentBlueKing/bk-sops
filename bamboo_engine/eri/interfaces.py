...
class EngineAPIHooksMixin:
    ...
    def pre_prepare_run_pipeline(
        self, pipeline: dict, root_pipeline_data: dict, **options
    ):
        """
...
class TaskMixin:
    ...
    def start_timeout_monitor(
        self, process_id: int, node_id: str, version: str, timeout: int
    ):
        """
...
class ProcessMixin:
    ...
    @abstractmethod
    def get_process_info_with_root_pipeline(
    ...
    @abstractmethod
    def get_suspended_process_info(
        self, suspended_by: str
    ) -> List[SuspendedProcessInfo]:
        """
...
class ScheduleMixin:
    ...
    @abstractmethod
    def get_schedule_with_node_and_version(
