...
class ConditionalParallelGateway(Node):
    ...
    def __init__(
        self, conditions: List[Condition], converge_gateway_id: str, *args, **kwargs
    ):
        """
...
class ContextValue(Representable):
    def __init__(
        self, key: str, type: ContextValueType, value: Any, code: Optional[str] = None
    ):
