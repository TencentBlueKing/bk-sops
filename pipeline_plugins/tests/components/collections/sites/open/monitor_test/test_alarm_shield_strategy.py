...
# mock path
GET_CLIENT_BY_USER = 'pipeline_plugins.components.collections.sites.open.monitor.alarm_shield_strategy.v1_0' \
                     '.get_client_by_user'
CMDB_GET_BIZ_HOST = 'gcloud.utils.cmdb.get_business_host'
BIZ_MODEL_SUPPLIER_ACCOUNT_FOR_BIZ = 'pipeline_plugins.components.collections.sites.open.monitor.' \
