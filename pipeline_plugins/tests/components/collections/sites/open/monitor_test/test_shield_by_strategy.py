...
from pipeline_plugins.components.collections.sites.open.monitor import AlarmShieldStrategyComponent


class AlarmShieldStrategyComponentTest(TestCase, ComponentTestMixin):
    ...
    def component_cls(self):
        return AlarmShieldStrategyComponent
