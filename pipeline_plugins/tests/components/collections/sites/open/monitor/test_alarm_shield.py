...
# mock path
GET_CLIENT_BY_USER = 'pipeline_plugins.components.collections.sites.open.monitor.alarm_shield.v1_0.get_client_by_user'
GET_MODULE_ID_LIST_BY_NAME = 'pipeline_plugins.components.collections.sites.open.monitor.alarm_shield.v1_0' \
...
GET_LIST_BY_SELECTED_NAMES = 'pipeline_plugins.components.collections.sites.open.monitor.alarm_shield.v1_0' \
                             '.get_list_by_selected_names'
GET_SERVICE_TEMPLATE_LIST = 'pipeline_plugins.components.collections.sites.open.monitor.alarm_shield.v1_0' \
                            '.get_service_template_list'
GET_SERVICE_TEMPLATE_LIST_BY_NAMES = 'pipeline_plugins.components.collections.sites.open.monitor.alarm_shield.v1_0' \
...
def get_set_list(username, bk_biz_id, bk_supplier_account, kwargs=None):
    set_list = [{
        'bk_set_id': 2,
        'bk_set_name': 'set_name1'
    }, {
        'bk_set_id': 3,
        'bk_set_name': 'set_name2'
    }, {
        'bk_set_id': 4,
        'bk_set_name': 'set_name3'
    }, {
        'bk_set_id': 5,
        'bk_set_name': 'set_name4'
    }]
    return set_list
