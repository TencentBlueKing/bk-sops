...
class MockClient(object):
    def __init__(self, plugin_operate=None, details_return=None, get_job_log_return=None):
        ...
        self.nodeman.plugin_operate = MagicMock(return_value=plugin_operate)
...
# mock path
GET_CLIENT_BY_USER = "pipeline_plugins.components.collections.sites.open.nodeman.plugin_operate.v1_0.get_client_by_user"
GET_CLIENT_BY_USER_BASE = "pipeline_plugins.components.collections.sites.open.nodeman.base.get_client_by_user"
...
OPERATE_SUCCESS_CASE = ComponentTestCase(
    ...
    execute_call_assertion=[
        CallAssertion(
            func=INSTALL_OR_OPERATE_SUCCESS_CLIENT.nodeman.plugin_operate,
            calls=[
                Call(
                    {
...
OPERATE_FAIL_CASE = ComponentTestCase(
    ...
    execute_call_assertion=[
        CallAssertion(
            func=CASE_FAIL_CLIENT.nodeman.plugin_operate,
            calls=[
                Call(
                    {
                        "job_type": "MAIN_INSTALL_PLUGIN",
