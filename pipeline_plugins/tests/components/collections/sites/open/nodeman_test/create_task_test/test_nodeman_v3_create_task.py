...
# mock path
GET_CLIENT_BY_USER = "pipeline_plugins.components.collections.sites.open.nodeman.create_task.v3_0.BKNodeManClient"
...
GET_HOST_ID_BY_INNER_IP_BASE = (
    "pipeline_plugins.components.collections.sites.open.nodeman.create_task.v3_0.get_host_id_by_inner_ip"
)
...
INSTALL_SUCCESS_CASE = ComponentTestCase(
    name="nodeman v3.0 install task success case",
    inputs={
        "bk_biz_id": "1",
...
REINSTALL_SUCCESS_CASE = ComponentTestCase(
    name="nodeman v3.0 reinstall task success case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
...
INSTALL_FAIL_CASE = ComponentTestCase(
    name="nodeman v3.0 install task failed case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
...
OPERATE_SUCCESS_CASE = ComponentTestCase(
    name="nodeman v3.0 operate task success case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
...
OPERATE_FAIL_CASE = ComponentTestCase(
    name="nodeman v3.0 operate task failed case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
...
REMOVE_SUCCESS_CASE = ComponentTestCase(
    name="nodeman v3.0 remove host task success case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
...
CHOOSABLE_PARAMS_CASE = ComponentTestCase(
    name="nodeman v3.0 choosable params case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
...
INSTALL_SUCCESS_CASE_WITH_TTJ = ComponentTestCase(
    name="nodeman v3.0 install task with tjj success case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
...
MULTI_CLOUD_ID_OPERATE_CASE = ComponentTestCase(
    name="nodeman v3.0 multi cloud_id operate task success case",
    inputs={
        "bk_biz_id": "1",
        "nodeman_node_type": "AGENT",
        "nodeman_op_info": {
