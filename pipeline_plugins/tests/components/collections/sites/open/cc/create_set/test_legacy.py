...
from pipeline_plugins.components.collections.sites.open.cc.create_set.legacy import CCCreateSetService


class CCCreateSetServiceLegacyTestCase(TestCase):
    def setUp(self):
        self.service = CCCreateSetService()
        self.service.logger = MagicMock()

    @patch("pipeline_plugins.components.collections.sites.open.cc.create_set.legacy.get_client_by_username")
    @patch("pipeline_plugins.components.collections.sites.open.cc.create_set.legacy.cc_format_prop_data")
    @patch("pipeline_plugins.components.collections.sites.open.cc.create_set.legacy.cc_format_tree_mode_id")
