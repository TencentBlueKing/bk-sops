...
from pipeline_plugins.components.collections.sites.open.cc.update_set.legacy import CCUpdateSetService


class CCUpdateSetServiceLegacyTestCase(TestCase):
    def setUp(self):
    ...
    @patch("pipeline_plugins.components.collections.sites.open.cc.update_set.legacy.get_client_by_username")
    @patch("pipeline_plugins.components.collections.sites.open.cc.update_set.legacy.cc_format_tree_set_id")
    def test_execute_success(self, mock_format_tree, mock_get_client):
        # Mock inputs
        executor = "admin"
        tenant_id = "1"
        biz_cc_id = "2"
    ...
    @patch("pipeline_plugins.components.collections.sites.open.cc.update_set.legacy.get_client_by_username")
    @patch("pipeline_plugins.components.collections.sites.open.cc.update_set.legacy.cc_format_prop_data")
    @patch("pipeline_plugins.components.collections.sites.open.cc.update_set.legacy.cc_format_tree_set_id")
