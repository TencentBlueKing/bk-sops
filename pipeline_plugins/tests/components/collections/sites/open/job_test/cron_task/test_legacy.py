...
# mock path
GET_CLIENT_BY_USER = "pipeline_plugins.components.collections.sites.open.job.cron_task.legacy.get_client_by_user"
...
UPDATE_CRON_STATUS_FAIL_CASE = ComponentTestCase(
    ...
    execute_assertion=ExecuteAssertion(
        ...
        outputs={
            "cron_id": 1,
            "ex_data": ("定时任务启动失败: [作业平台]定时任务启动发生异常:  update_cron_status fail"),
            "status": "暂停",
        },
    ),
    schedule_assertion=None,
