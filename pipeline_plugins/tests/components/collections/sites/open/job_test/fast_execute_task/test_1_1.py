...
# mock path
GET_CLIENT_BY_USER = (
    "pipeline_plugins.components.collections.sites.open.job.fast_execute_script.v1_1.get_client_by_user"
)
GET_NODE_CALLBACK_URL = (
    "pipeline_plugins.components.collections.sites.open.job.fast_execute_script.v1_1.get_node_callback_url"
)
CC_GET_IPS_INFO_BY_STR = (
    "pipeline_plugins.components.collections.sites.open.job.fast_execute_script.v1_1.cc_get_ips_info_by_str"
)
