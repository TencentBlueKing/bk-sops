...
from pipeline_plugins.components.collections.sites.open.job.push_local_files.v2_0_0 import JobPushLocalFilesComponent
...
# mock path
GET_CLIENT_BY_USER = "pipeline_plugins.components.collections.sites.open.job.push_local_files.v2_0_0.get_client_by_user"
CC_GET_IPS_INFO_BY_STR = (
    "pipeline_plugins.components.collections.sites.open.job.push_local_files.v2_0_0.cc_get_ips_info_by_str"
)

ENVIRONMENT_VAR_GET = (
    "pipeline_plugins.components.collections.sites.open.job.push_local_files.v2_0_0."
    "EnvironmentVariables.objects.get_var"
)
FACTORY_GET_MANAGER = (
    "pipeline_plugins.components.collections.sites.open.job.push_local_files.v2_0_0.ManagerFactory.get_manager"
)
