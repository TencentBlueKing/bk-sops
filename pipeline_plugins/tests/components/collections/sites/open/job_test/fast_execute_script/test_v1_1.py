...
MANUAL_SCRIPT_SUCCESS_CASE = ComponentTestCase(
    name="v1.1 manual script success",
    inputs={
        "biz_cc_id": 1,
...
GENERAL_SCRIPT_SUCCESS_CASE = ComponentTestCase(
    name="v1.1 general script success",
    inputs={
        "biz_cc_id": 1,
...
PUBLIC_SCRIPT_SUCCESS_CASE = ComponentTestCase(
    name="v1.1 public script success",
    inputs={
        "biz_cc_id": 1,
...
# Case 4: Script Not Found
SCRIPT_NOT_FOUND_CLIENT = MockClient(
    get_script_list_return={"result": True, "data": {"data": [{"id": 777, "name": "other_script"}], "total": 1}},
)

SCRIPT_NOT_FOUND_CASE = ComponentTestCase(
    name="v1.1 script not found",
    inputs={
        "biz_cc_id": 1,
        "job_script_source": "general",
        "job_script_list_general": "test_script",
