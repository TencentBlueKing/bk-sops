...
class CCBatchTransferHostModuleComponentTest(TestCase, ComponentTestMixin):
    ...
    def cases(self):
        return [
            TRANSFER_HOST_MODULE_SUCCESS_CASE,
        ]


class MockClient(object):
    def __init__(self, batch_transfer_host_module_return=None,
...
GET_CLIENT_BY_USER = "pipeline_plugins.components.collections.sites.open.cc.batch_transfer_host_module.v1_0.get_client_by_user"
...
CC_LIST_SELECT_NODE_INST_ID = (
    "pipeline_plugins.components.collections.sites.open.cc.batch_transfer_host_module.v1_0" ".cc_list_select_node_inst_id"
)
...
TRANSFER_MODULE_SUCCESS_INPUTS = {
    'cc_module_select_method': 'manual', 'cc_host_transfer_detail': [
        {'cc_transfer_host_ip': '2.5.5.6', 'cc_transfer_host_target_module': '蓝鲸>Tun>set'}
    ],
    'cc_transfer_host_template_break_line': '', '_loop': 1
}
