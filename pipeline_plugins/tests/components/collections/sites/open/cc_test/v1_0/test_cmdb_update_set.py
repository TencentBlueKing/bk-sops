...
from pipeline_plugins.components.collections.sites.open.cc_update_set.v1_0 import (
    CCUpdateSetComponent
)


class CCUpdateSetComponentTest(TestCase, ComponentTestMixin):
    def component_cls(self):
        return CCUpdateSetComponent
...
GET_CLIENT_BY_USER = 'pipeline_plugins.components.collections.sites.open.cc_update_set.v1_0.get_client_by_user'
