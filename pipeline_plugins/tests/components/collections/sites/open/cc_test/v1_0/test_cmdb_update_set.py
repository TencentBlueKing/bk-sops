...
from pipeline_plugins.components.collections.sites.open.cc_update_set.v1_0 import CCUpdateSetComponent
...
SELECT_BY_TEXT_SUCCESS_CLIENT = MockClient(
    ...
    update_set_return={"result": True, "code": 0, "message": "", "data": {}},
)
