...
from pipeline_plugins.components.collections.sites.open.cc_update_module.v1_0 import (
...
GET_CLIENT_BY_USER = 'pipeline_plugins.components.collections.sites.open.cc_update_module.v1_0' \
                     '.get_client_by_user'
CC_LIST_MATCH_NODE_INST_ID = 'pipeline_plugins.components.collections.sites.open.cc_update_module.v1_0' \
