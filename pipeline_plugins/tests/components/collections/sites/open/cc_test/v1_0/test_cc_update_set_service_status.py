...
from pipeline_plugins.components.collections.sites.open.cc_update_set_service_status.v1_0 import (
    CCUpdateSetServiceStatusComponent
)


class CCUpdateSetServiceStatusComponentTest(TestCase, ComponentTestMixin):
...
GET_CLIENT_BY_USER = 'pipeline_plugins.components.collections.sites.open.cc_update_set_service_status.v1_0' \
                     '.get_client_by_user'
