...
from pipeline_plugins.components.collections.sites.open.cc_transfer_host_module.v1_0 import (
...
class MockClient(object):
    def __init__(self, get_mainline_object_topo_return=None, search_biz_inst_topo_return=None,
                 transfer_host_module_return=None):
        self.cc = MagicMock()
...
GET_CLIENT_BY_USER = 'pipeline_plugins.components.collections.sites.open.cc_transfer_host_module.v1_0' \
                     '.get_client_by_user'
GET_IP_BY_REGEX = 'pipeline_plugins.components.collections.sites.open.cc_transfer_host_module.v1_0.get_ip_by_regex'
CC_GET_HOST_ID_BY_INNERIP = 'pipeline_plugins.components.collections.sites.open.cc_transfer_host_module.v1_0' \
                            '.cc_get_host_id_by_innerip'
CC_LIST_MATCH_NODE_INST_ID = 'pipeline_plugins.components.collections.sites.open.cc_transfer_host_module.v1_0' \
...
SELECT_BY_TEXT_SUCCESS_INPUTS = {
    ...
    'cc_module_select_text': u'    蓝鲸>Tun>set>module\n\n',
...
SELECT_BY_TEXT_ERROR_PATH_FAIL_INPUTS = {
    ...
    'cc_module_select_method': 'text',
    'cc_module_select_topo': [],
    'cc_module_select_text': u'    蓝鲸>Yun >set>module\n\n',
    'cc_host_ip': '1.1.1.1;2.2.2.2',
    'cc_is_increment': 'false',
    '_loop': 1
}
...
SELECT_BY_TEXT_ERROR_PATH_FAIL_CASE = ComponentTestCase(
    ...
    execute_assertion=ExecuteAssertion(
        success=False, outputs={
            'ex_data': u'不存在该拓扑路径：蓝鲸>Yun>set>module'
        }),
    schedule_assertion=None,
    execute_call_assertion=[
        CallAssertion(func=CC_GET_HOST_ID_BY_INNERIP, calls=[Call('admin', 2, ['1.1.1.1', '2.2.2.2'], 0)])
...
SELECT_BY_TEXT_ERROR_LEVEL_FAIL_INPUTS = {
    ...
    'cc_module_select_method': 'text',
    'cc_module_select_topo': [],
    'cc_module_select_text': u'    蓝鲸>Yun >   module\n\n',
    'cc_host_ip': '1.1.1.1;2.2.2.2',
    'cc_is_increment': 'false',
    '_loop': 1
}
...
SELECT_BY_TEXT_ERROR_LEVEL_FAIL_CASE = ComponentTestCase(
    ...
    execute_assertion=ExecuteAssertion(
        success=False, outputs={
            'ex_data': u'输入文本路径[蓝鲸>Yun>module]与业务拓扑层级不匹配'
        }),
    schedule_assertion=None,
    execute_call_assertion=[
        CallAssertion(func=CC_GET_HOST_ID_BY_INNERIP, calls=[Call('admin', 2, ['1.1.1.1', '2.2.2.2'], 0)])
