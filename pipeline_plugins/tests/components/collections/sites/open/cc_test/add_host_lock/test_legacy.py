...
# mock path
GET_CLIENT_BY_USER = "pipeline_plugins.components.collections.sites.open.cc.add_host_lock.legacy.get_client_by_user"
CC_GET_IPS_INFO_BY_STR = (
    "pipeline_plugins.components.collections.sites." "open.cc.add_host_lock.legacy.cc_get_ips_info_by_str"
)
...
ADD_HOST_LOCK_SUCCESS_CASE = ComponentTestCase(
    ...
    parent_data={"executor": "executor_token", "biz_cc_id": 2, "biz_supplier_account": 0, "language": "English"},
...
ADD_HOST_LOCK_FAIL_CASE = ComponentTestCase(
    ...
    execute_assertion=ExecuteAssertion(
        ...
        outputs={
            "ex_data": (
                'Conf System(CMDB) API cc.add_host_lock returned false, params={"id_list":["1.1.1.1",'
                '"2.2.2.2"]}, error=fail'
            )
        },
    ),
