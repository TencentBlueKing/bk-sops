...
from pipeline_plugins.components.collections.alarm_shield import (
...
class TestAlarmShield(TestCase):
    ...
    def test_scope(self, mock_request):
        mock_request.return_value = Response({'result': True, 'data': 'success', 'code': 200})
        data = Data('business')
    ...
    def test_ip(self, mock_request):
        ...
        mock_request.side_effect = [
            ...
            Response({'result': True, 'data': 'success', 'code': 200}),
    ...
    def test_strategy(self, mock_request):
        strategy_detail = {"message": "OK", "code": 200, "data": {"item_list": [{"level": [2, 3]}]}, "result": True}
        mock_request.side_effect = [
