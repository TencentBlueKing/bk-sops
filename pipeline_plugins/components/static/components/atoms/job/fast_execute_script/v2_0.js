 ...
 */
 ...
 (function () {
    $.atoms.job_fast_execute_script = [
        ...
        {
            tag_code: "job_script_fail_auto_process_tag",
            type: "section",
            attrs: {
                name: gettext("失败自动处理"),
            }
        ...
        {
            tag_code: "job_script_process_action",
            type: "select",
            attrs: {    
                name: gettext("处理策略"),
        ...
        {
            tag_code: "job_script_history_tag",
            type: "section",
            attrs: {
        ...
        {
            tag_code: "job_script_history_instance_id",
            type: "input",
            attrs: {
                name: gettext("执行历史ID"),
        ...
        {
            tag_code: "job_script_history_instance_action",
            type: "select",
            attrs: {
                name: gettext("动作"),
