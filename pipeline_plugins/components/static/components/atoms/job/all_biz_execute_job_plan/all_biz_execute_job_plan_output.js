    ...
    $.atoms.all_biz_execute_job_plan = [
        ...
        },
        {
            ...
            attrs: {
                ...
                remote_url: $.context.get("site_url") + "pipeline/job_get_instance_detail/" + ($.context.getInput("bk_biz_id") || $.context.getBkBizId()) + "/" + $.context.getOutput("job_inst_id") + "/?bk_scope_type=biz_set"
            }
        },
        {
            tag_code: "job_log",
