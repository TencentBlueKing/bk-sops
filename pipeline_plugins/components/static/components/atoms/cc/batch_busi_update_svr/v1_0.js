 ...
 */
(function () {
    $.atoms.cc_batch_busi_update_svr = [
        {
            tag_code: "cc_busi_select_method",
            type: "radio",
            attrs: {
                name: gettext("填参方式"),
                hookable: false,
        ...
        },
        {
            ...
            attrs: {
                ...
                columns: [
                    {
                        tag_code: "cc_busi_update_svr_IP",
                        type: "input",
                        attrs: {
                            name: gettext("ID_IP"),
                    ...
                    {
                        tag_code: "cc_busi_update_svr_business",
                        type: "input",
                        attrs: {
                            name: gettext("目标模块"),
                            placeholder: gettext("必填项"),
        ...
        {
            tag_code: "cc_busi_template_break_line",
            type: "input",
            attrs: {
