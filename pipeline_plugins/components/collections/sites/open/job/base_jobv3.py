...
def get_jobv3_sops_var_dict(client, service_logger, job_instance_id, bk_biz_id):
    """
    :param client:
    :param service_logger: 组件日志对象
    :param job_instance_id: 作业实例id
    :param bk_biz_id 业务ID
    获取到的get_job_instance_status实例
    {
        "message": "",
        "code": 0,
        "data": {
            "job_instance": {
                "job_instance_id": 20000000418,
                "bk_biz_id": 89,
                "name": "多步骤作业测试",
                "start_time": 1620613834433,
                "create_time": 1620613834211,
                "status": 4,
                "end_time": 1620613851741,
                "total_time": 17308
            },
            "finished": true,
            "step_instance_list": [
                {
                    ...
                    "total_time": 17249,
                    "name": "步骤执行脚本1",
                    "start_time": 1620613834478,
                    "step_instance_id": 20000000422,
                    "step_ip_result_list": [
                        {
                            "status": 310,
                            "total_time": 100,
                    ...
                    "create_time": 1620613834250,
                    "end_time": 1620613851706,
                    "execute_count": 0,
                    "type": 1
                },
                {
        ...
        "result": true,
        "request_id": "619a909ca2084d78bba6859ed8223432"
    }
    :return:
...
class Jobv3Service(Service):
    ...
    def schedule(self, data, parent_data, callback_data=None):
        ...
        if status in JOB_SUCCESS:
            ...
            if self.reload_outputs:
                ...
                if step_instance_var_list:
                    for global_var in step_instance_var_list[-1]["global_var_list"]:
                        if global_var["type"] != JOBV3_VAR_TYPE_IP:
            ...
            get_jobv3_sops_var_dict_return = get_jobv3_sops_var_dict(
                data.outputs.client,
                self.logger,
                job_instance_id,
...
class JobScheduleService(Jobv3Service):
    __need_schedule__ = True
