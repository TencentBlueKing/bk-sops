    ...
    def inputs_format(self):
        return [
            ...
            self.InputItem(
                ...
                type="string",
                schema=StringItemSchema(description=_("模块文本路径")),
            ),
            self.InputItem(
                name=_("服务状态"),
                key="cc_set_status",
...
class CCUpdateSetServiceStatusComponent(Component):
    ...
    form = '{static_url}components/atoms/cc/update_set_service_status/{ver}.js'.format(static_url=settings.STATIC_URL,
