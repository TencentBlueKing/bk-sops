...
class CCTransferHostToRecoveryService(Service):
    def inputs_format(self):
        return [
            ...
            self.InputItem(
                ...
                key="cc_host_ip",
                type="string",
                schema=StringItemSchema(description=_("转移到待回收模块的主机内网 IP，多个用英文逗号 `,` 分隔")),
            ),
        ]
    ...
    def execute(self, data, parent_data):
        ...
        # 查询对应的待回收模块id
        cc_module_select_text = "空闲机池>待回收"
        ...
        if transfer_result["result"]:
            ...
            message = cc_handle_api_error("cc.transfer_host_to_recovery_module", transfer_kwargs, transfer_result)
