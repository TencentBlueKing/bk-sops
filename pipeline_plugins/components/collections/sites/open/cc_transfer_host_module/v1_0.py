    ...
    def inputs_format(self):
        return [
            ...
            self.InputItem(
                ...
                key="cc_is_increment",
                type="string",
                schema=StringItemSchema(description=_(u"主机转移方式，覆盖(false)或追加(true)"), enum=["false", "true"]),
            ),
        ]
    ...
    def execute(self, data, parent_data):
        ...
        if cc_module_select_method == "topo":
            ...
            topo_tree = client.cc.search_biz_inst_topo(
                {"bk_biz_id": biz_cc_id, "bk_supplier_account": supplier_account,}
            )["data"]
            # 获取模块bk_inst_id
...
class CCTransferHostModuleComponent(Component):
    ...
    form = "{static_url}components/atoms/cc/{ver}/cc_transfer_host_module.js".format(
