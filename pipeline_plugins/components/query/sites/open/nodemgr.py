...
nodemgr_urlpatterns = [
    re_path(r"^nodemgr_get_networkarea/$", nodemgr_get_networkarea),
    re_path(r"^nodemgr_get_networkunit/(?P<networkarea_id>\w+)/$", nodemgr_get_networkunit),
    re_path(r"^nodemgr_get_os_type/(?P<node_role>\w+)/$", nodemgr_get_os_type),
    re_path(r"^nodemgr_get_release_version/(?P<node_role>\w+)/$", nodemgr_get_release_version),
    re_path(r"^nodemgr_get_plugin/(?P<biz_id>\d+)/$", nodemgr_get_plugin),
    re_path(r"^nodemgr_get_plugin_version/(?P<plugin_pkg_name>.+)/$", nodemgr_get_plugin_version),
]
