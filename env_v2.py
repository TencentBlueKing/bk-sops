...
# 文档中心
BK_DOC_CENTER_HOST = os.getenv("BK_DOC_CENTER_HOST", "{}/o/bk_docs_center".format(BK_PAAS_HOST))
...
BK_NODEMGR_API_ENTRY = os.getenv("BK_NODEMGR_API_ENTRY", "")
BK_NODEMGR_WEB_URL = os.getenv("BK_NODEMGR_WEB_URL", "")
BK_NODEMGR_DEFAULT_LOGIN_INFO = os.getenv("BK_NODEMGR_DEFAULT_LOGIN_INFO", "")
BK_NODEMGR_DEFAULT_PROXY_INFO = os.getenv("BK_NODEMGR_DEFAULT_PROXY_INFO", "")
...
# 沙箱可导入模块，逗号分隔；空字符串表示不预置任何模块。支持 path:alias。
SOPS_MAKO_IMPORT_MODULES = os.getenv("BKAPP_SOPS_MAKO_IMPORT_MODULES", "")
SOPS_MAKO_WHITELIST_MODE = os.getenv("BKAPP_SOPS_MAKO_WHITELIST_MODE", "enforce")
...
BKAPP_REDIS_CA = os.getenv("BKAPP_REDIS_CA")
BKAPP_REDIS_CERT = os.getenv("BKAPP_REDIS_CERT")
BKAPP_REDIS_CERT_KEY = os.getenv("BKAPP_REDIS_CERT_KEY")
BKAPP_REDIS_INSECURE_SKIP_VERIFY = os.getenv("BKAPP_REDIS_INSECURE_SKIP_VERIFY", False)
BKAPP_REDIS_CERT_REQS = os.getenv("BKAPP_REDIS_CERT_REQS")
BKAPP_REDIS_CHECK_HOSTNAME = os.getenv("BKAPP_REDIS_CHECK_HOSTNAME")
...
BK_PAAS_ESB_API_HOST = BK_PAAS_HOST
