...
BKAPP_REDIS_CA = os.getenv("REDIS_CA")
BKAPP_REDIS_CERT = os.getenv("REDIS_CERT")
BKAPP_REDIS_CERT_KEY = os.getenv("REDIS_CERT_KEY")
BKAPP_REDIS_INSECURE_SKIP_VERIFY = os.getenv("REDIS_INSECURE_SKIP_VERIFY", False)
BKAPP_REDIS_CERT_REQS = os.getenv("REDIS_CERT_REQS")
BKAPP_REDIS_CHECK_HOSTNAME = os.getenv("REDIS_CHECK_HOSTNAME")
