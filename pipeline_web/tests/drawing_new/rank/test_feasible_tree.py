...
class TestFeasibleTree(TestCase):
    ...
    def test_feasible_tree_ranker(self):
        ...
        self.assertEqual(ranks, {
            'nodea4bb3693dfb8d99d2084cee2fb8b': 1,
            'nodeeb9b2a00e46adacd9f57720e8cca': 0,
            'node0dfa73e80b9bf40aa05f2442bb3d': 0,
            'node4149a8d446a7fc325b66a7ee4350': -1,
            'nodeaf2161961809a91ebb00db88c814': -2,
            'node402bea676e660fab4cc643afafc8': -3
        })
