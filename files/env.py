...
# BKREPO相关配置信息，启用
BKREPO_ENDPOINT_URL = os.getenv("BKAPP_BKREPO_ENDPOINT_URL") or os.getenv("BKREPO_ENDPOINT_URL")
BKREPO_USERNAME = os.getenv("BKAPP_BKREPO_USERNAME") or os.getenv("BKREPO_USERNAME")
BKREPO_PASSWORD = os.getenv("BKAPP_BKREPO_PASSWORD") or os.getenv("BKREPO_PASSWORD")
BKREPO_PROJECT = os.getenv("BKAPP_BKREPO_PROJECT") or os.getenv("BKREPO_PROJECT")
BKREPO_BUCKET = os.getenv("BKAPP_BKREPO_BUCKET") or os.getenv("BKREPO_BUCKET")
