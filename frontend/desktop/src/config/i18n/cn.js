const cn = {
    ...
    '。': '。',
    '条件': '条件',
    '将标准运维的流程快速生成一个独立的蓝鲸SaaS 应用，同样可在蓝鲸应用市场进行搜索和添加。这种不需要开发，零成本快速生成的 SaaS 应用称为 “轻应用”。': '将标准运维的流程快速生成一个独立的蓝鲸SaaS 应用，同样可在蓝鲸应用市场进行搜索和添加。这种不需要开发，零成本快速生成的 SaaS 应用称为 “轻应用”。',
