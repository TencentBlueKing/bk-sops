const cn = {
    ...
    '分支网关：': '分支网关：',
    '执行符合条件的流出分支。多个条件符合时，会中断流程并报错提示满足条件的多个流出分支。': '执行符合条件的流出分支。多个条件符合时，会中断流程并报错提示满足条件的多个流出分支。',
    '汇聚网关：': '汇聚网关：',
    ...
    '权限中心': '权限中心',
    '权限中心地址未配置，请联系管理员': '权限中心地址未配置，请联系管理员',
    ...
    '直接离开': '直接离开',
    '流程名': '流程名',
    'ID/流程名/标签/更新人/创建人/子流程更新/执行代理人': 'ID/流程名/标签/更新人/创建人/子流程更新/执行代理人',
    'ID/流程名/创建人/更新人': 'ID/流程名/创建人/更新人',
    '任务名': '任务名',
    'task_任务名': '任务名',
    'ID/任务名/创建人/执行人/状态/执行方式/执行代理人': 'ID/任务名/创建人/执行人/状态/执行方式/执行代理人',
    'ID/任务名/流程ID/创建人/执行人/状态/执行方式/执行代理人': 'ID/任务名/流程ID/创建人/执行人/状态/执行方式/执行代理人',
    'ID/任务名/创建人/更新人/状态': 'ID/任务名/创建人/更新人/状态',
    'ID/任务名/创建人/更新人/状态/流程更新': 'ID/任务名/创建人/更新人/状态/流程更新',
    '应用名': '应用名',
    '应用名/更新人': '应用名/更新人',
    ...
    '确定强制终止节点【n】 ？': '确定强制终止节点【{n}】 ？',
    '强制终止将强行修改节点状态为失败，但不会中断已经发送到其它系统的请求': '强制终止将强行修改节点状态为失败，但不会中断已经发送到其它系统的请求',
    '确定强制终止子流程【n】 ？': '确定强制终止子流程【{n}】 ？',
    '强制终止子流程将直接终止子流程发起的任务，终止后仅能重试或跳过子流程': '强制终止子流程将直接终止子流程发起的任务，终止后仅能重试或跳过子流程',
    '子流程【n】已被强制终止': '子流程【{n}】已被强制终止',
    '节点【n】已被强制终止': '节点【{n}】已被强制终止',
    ...
    '确定暂停子流程【n】 ？': '确定暂停子流程【{n}】 ？',
    '确定继续子流程【n】 ？': '确定继续子流程【{n}】 ？',
    '任务已暂停，您还可根据需要修改入参': '任务已暂停，您还可根据需要修改入参',
    '已成功修改入参，是否继续执行任务？': '已成功修改入参，是否继续执行任务？',
    '参数未修改，是否继续执行任务？': '参数未修改，是否继续执行任务？',
    '节点审批成功': '节点审批成功',
    '当前项目不存在或已归档': '当前项目不存在或已归档',
    '返回首页': '返回首页',
    '请至少选择一个节点': '请至少选择一个节点',
    ...
    '请输入群 ID，多个 ID 以逗号隔开': '请输入群 ID，多个 ID 以逗号隔开',
    ...
    '立即更新': '立即更新',
    '流程批量更新成功！': '流程批量更新成功！',
    '保存后子流程更新将立即生效，请谨慎操作': '保存后子流程更新将立即生效，请谨慎操作',
    '立即更新并保存': '立即更新并保存',
    '跳转到流程': '跳转到流程',
    '代码框自动开启免渲染模式提醒': '代码框自动开启免渲染模式提醒',
    '检测到【n】代码框没有使用变量，保存该节点代码框将自动改为免渲染模式。届时所有标准运维变量将不会被渲染。请确定是否保存': '检测到【{n}】代码框没有使用变量，保存该节点代码框将自动改为免渲染模式。届时所有标准运维变量将不会被渲染。请确定是否保存',
    '即将废弃': '即将废弃',
    '个人中心': '个人中心',
    '是否需要时区': '是否需要时区',
    '任务时区': '任务时区',
    ...
    '重试间隔': '重试间隔',
    '用户名': '用户名',
    '重试次数不能超过5次': '重试次数不能超过5次',
    '回调内容示例': '回调内容示例',
    '支持在流程结束（成功或失败）后，把任务输出的内容和执行结果作为参数调用回调接口': '支持在流程结束（成功或失败）后，把任务输出的内容和执行结果作为参数调用回调接口',
    '调试': '调试',
    '是否开启': '是否开启',
    '请求发送成功': '请求发送成功',
    '请求发送失败': '请求发送失败',
    ...
    '调试结果': '调试结果',
    '请选择请求方法': '请选择请求方法',
    '请输入正确的请求URL': '请输入正确的请求URL',
    '请输入用户名或密码': '请输入用户名或密码',
    '请输入token': '请输入token',
    '请输入完整的设置信息': '请输入完整的设置信息',
    '请输入重试次数': '请输入重试次数',
    '请输入请求超时时间': '请输入请求超时时间',
    '请输入重试间隔': '请输入重试间隔',
    '请输入请求URL': '请输入请求URL',
    ...
    '回调结果': '回调结果',
    '请求状态码': '请求状态码',
    '请求返回message': '请求返回message',
    '回调记录': '回调记录',
    '请输入正确的认证信息': '请输入正确的认证信息',
    '请求超时时间不能超过10秒': '请求超时时间不能超过10秒',
    '重试间隔不能超过600秒': '重试间隔不能超过600秒',
    '仅项目可见的': '仅项目可见的',
    '可见范围配置': '可见范围配置',
    '粘贴': '粘贴',
    '复制失败': '复制失败',
    '没有找到匹配的项目': '没有找到匹配的项目',
    '剪贴板中没有数据': '剪贴板中没有数据',
    '粘贴数据与当前数据相同': '粘贴数据与当前数据相同',
    '粘贴成功': '粘贴成功',
    '粘贴成功，部分项目因权限问题被过滤': '粘贴成功，部分项目因权限问题被过滤',
    '粘贴失败': '粘贴失败',
    '编写脚本': '编写脚本',
    '脚本检查': '脚本检查',
    '排查失败的原因': '排查失败的原因',
    ...
    '请输入群聊ID': '请输入群聊ID',
    '请输入需要@的人': '请输入需要@的人',
    '请输入群聊机器人webhook': '请输入群聊机器人webhook',
    '生成进度': '生成进度',
    '正在准备生成环境...': '正在准备生成环境...',
    '生成完成！': '生成完成！',
    '正在分析流程描述...': '正在分析流程描述...',
    '正在调用 AI 模型...': '正在调用 AI 模型...',
    '正在生成流程结构...': '正在生成流程结构...',
    '正在优化流程布局...': '正在优化流程布局...',
    '正在完成最后处理...': '正在完成最后处理...',
    '即将完成，请稍候...': '即将完成，请稍候...',
    ...
    'AI 生成流程': 'AI 生成流程',
    '流程描述': '流程描述',
    'AI 正在生成流程，请稍候...': 'AI 正在生成流程，请稍候...',
    '请描述您想要创建的流程': '请描述您想要创建的流程',
    '历史任务': '历史任务',
    '您当前的企业空间是【tenant】，无法访问该链接，请您尝试返回登录页面切换其他企业空间访问。': '您当前的企业空间是【{tenant}】，无法访问该链接，请您尝试返回登录页面切换其他企业空间访问。',
    '是否显示时区': '是否显示时区',
    '个人设置': '个人设置',
    'AI排版': 'AI排版',
    'AI排版完成,原内容在本地快照中': 'AI排版完成,原内容在本地快照中',
    '使用上一次参数': '使用上一次参数',
    '确认使用上一次参数？': '确认使用上一次参数？',
    '将会使用该流程上一次执行的参数值填充表单': '将会使用该流程上一次执行的参数值填充表单',
    '参数加载成功': '参数加载成功',
    '输入关键词搜索,批量搜索使用逗号分隔': '输入关键词搜索,批量搜索使用逗号分隔',
    '个周期任务涉及到流程的更新，请及时处理。': '个周期任务涉及到流程的更新，请及时处理。',
    '流程更新': '流程更新'
}
