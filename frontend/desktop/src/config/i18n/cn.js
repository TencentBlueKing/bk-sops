const cn = {
    ...
    'tagCodeEditorTips': '脚本内容{0}全局变量。检测到疑似 {1} 处引用，建议使用脚本参数传入。',
    '不再支持': '不再支持',
    '添加收藏': '添加收藏',
    '空间': '空间',
    '管理空间': '管理空间',
    ...
    '编辑空间': '编辑空间',
    '空间名称': '空间名称',
    '不超过 50 个字符': '不超过 50 个字符',
    '空间代号': '空间代号',
    '不超过 50 个字符，由字母、数字、下划线组成': '不超过 50 个字符，由字母、数字、下划线组成',
    '空间管理员': '空间管理员',
    '可管理空间和流程，创建人自动成为管理员': '可管理空间和流程，创建人自动成为管理员',
    '空间成员': '空间成员',
    '仅可管理空间下的流程': '仅可管理空间下的流程',
    '空间说明': '空间说明',
    '至少 5 个字符': '至少 5 个字符',
    '转移': '转移',
    '转移流程': '转移流程',
    '转移至': '转移至',
    '清空筛选': '清空筛选',
    '可申请管理空间内的所有流程': '可申请管理空间内的所有流程',
    '申请空间成员': '申请空间成员',
    '可申请管理空间配置': '可申请管理空间配置',
    '及管理空间内的所有流程': '及管理空间内的所有流程',
    '申请空间管理员': '申请空间管理员',
    '需要有新建空间的权限': '需要有新建空间的权限',
    '请选择空间': '请选择空间'
}
