const cn = {
    ...
    '汇聚网关：': '汇聚网关：',
    '所有进入顺序流的分支都到达以后，流程才会通过汇聚网关。': '所有进入顺序流的分支都到达以后，流程才会通过汇聚网关。',
    '复位': '复位',
    '节点框选': '节点框选',
    '排版': '排版',
    '全选': '全选',
    ...
    '未命名': '未命名',
    '模块配置': '模块配置',
    '请输入模块绝对路径，如a.b.c，多个用英文逗号 `,` 或换行分隔': '请输入模块绝对路径，如a.b.c，多个用英文逗号 `,` 或换行分隔',
    '子模块名称': '子模块名称',
    '版本': '版本',
    '导入模块': '导入模块',
    ...
    '分支名称': '分支名称',
    '表达式': '表达式',
    '支持 "==、!=、>、>=、<、<=、in、notin" 等二元操作符和 "and、or、True/true、False/false" 等关键字语法，还支持通过 "${key}" 方式引用全局变量。示例：`${key1} >= 3 and ${key2} == "Test"`': '支持 "==、!=、>、>=、<、<=、in、notin" 等二元操作符和 "and、or、True/true、False/false" 等关键字语法，还支持通过 "${key}" 方式引用全局变量。示例：`${key1} >= 3 and ${key2} == "Test"`',
    '请选择插件': '请选择插件',
    '请选择插件版本': '请选择插件版本',
    '请选择流程模板': '请选择流程模板',
    '选择': '选择',
    ...
    '变量名称': '变量名称',
    '变量KEY': '变量KEY',
    '已存在相同Key且版本不同的变量，请新建变量': '已存在相同Key且版本不同的变量，请新建变量',
    '创建新变量': '创建新变量',
    '是否复用变量': '是否复用变量',
    '已选': '已选',
    ...
    '替换': '替换',
    '保存时间': '保存时间',
    '无数据，请手动添加缓存或等待自动保存': '无数据，请手动添加缓存或等待自动保存',
    '替换模板': '替换模板',
    '是否替换模板？': '是否替换模板？',
    '简述：': '简述：',
    '本地缓存可以用于记录当前流程所有信息，包括流程的节点编排、全局变量、名称、基础属性等信息。本地缓存支持每个流程最多保存50个最近记录，该数据存储至本地浏览器中，每个用户只能查看和编辑自己的本地缓存。': '本地缓存可以用于记录当前流程所有信息，包括流程的节点编排、全局变量、名称、基础属性等信息。本地缓存支持每个流程最多保存50个最近记录，该数据存储至本地浏览器中，每个用户只能查看和编辑自己的本地缓存。',
    '重置模板': '重置模板',
    '流程模板数据': '流程模板数据',
    '通知方式': '通知方式',
    '超时时间(分钟)': '超时时间(分钟)',
    ...
    '替换流程成功': '替换流程成功',
    '新增流程本地缓存成功': '新增流程本地缓存成功',
    '替换流程自动保存': '替换流程自动保存',
    '排版完成，原内容在本地缓存中': '排版完成，原内容在本地缓存中',
    '双击左键': '双击左键',
    ...
    '模板文件上传为空': '模板文件上传为空',
    '模板上传内容不合法，请重新选择文件': '模板上传内容不合法，请重新选择文件',
