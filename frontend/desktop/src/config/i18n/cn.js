const cn = {
    ...
    '转换为变量集中维护': '转换为变量集中维护',
    '确认批量删除变量？': '确认批量删除变量？',
    '以下自定义流程变量将被彻底删除': '以下自定义流程变量将被彻底删除',
    '更多': '更多',
    '选择变量后预览代码': '选择变量后预览代码',
    '复制代码': '复制代码',
    '变量已被引用，key 不可修改': '变量已被引用，key 不可修改',
    '节点输出型变量不支持删除，当来源数为 0 时即自动删除': '节点输出型变量不支持删除，当来源数为 0 时即自动删除',
    '节点输入型变量不支持删除，当来源数为 0 时即自动删除': '节点输入型变量不支持删除，当来源数为 0 时即自动删除',
    '插入已有变量': '插入已有变量',
    '新建并插入变量': '新建并插入变量',
    '所属插件': '所属插件',
    '所属模板': '所属模板',
    ...
    '使用变量': '使用变量',
    '变量详情': '变量详情',
    '插件已失效，请重新选择': '插件已失效，请重新选择',
    '无法取消使用变量': '无法取消使用变量',
    '变量已被引用，无法取消使用。如需取消，请先清除所有引用': '变量已被引用，无法取消使用。如需取消，请先清除所有引用',
    '查看引用': '查看引用',
    '执行设置': '执行设置',
    '草稿': '草稿',
    '正式': '正式',
