const cn = {
    ...
    '设置默认方案': '设置默认方案',
    '默认': '默认',
    '流程执行时，默认执行当前方案的组合。': '流程执行时，默认执行当前方案的组合。',
    '方案内容': '方案内容',
    '变更节点对比': '变更节点对比',
    '选中状态': '选中状态',
    ...
    '自动隐藏': '自动隐藏',
    '自动隐藏在显示状态下触发，当触发条件都满足时，才会在编辑页面隐藏，但是不会对传参产生影响': '自动隐藏在显示状态下触发，当触发条件都满足时，才会在编辑页面隐藏，但是不会对传参产生影响',
    '启动失败': '启动失败',
    '节点ID': '节点ID',
    '表格设置': '表格设置',
    '字段显示设置': '字段显示设置',
    ...
    '每次创建任务会使用该执行方案的最新版本且不会提示该节点需要更新': '每次创建任务会使用该执行方案的最新版本且不会提示该节点需要更新',
    '如果引用执行方案更新，需要填写新的变量值，请重新打开对应的子流程节点进行填写，或者在子流程节点表单填写时填写非必填项的变量值': '如果引用执行方案更新，需要填写新的变量值，请重新打开对应的子流程节点进行填写，或者在子流程节点表单填写时填写非必填项的变量值'
}
