const en = {
    ...
    'task_周期任务': 'Scheduled Task',
    '计划任务': 'One-Time Scheduled Tasks',
    'task_计划任务': 'One-Time Scheduled Task',
    '轻应用': 'Mini-APPs',
    '职能化': 'Helper Team',
    ...
    '项目级别的变量建立后,可以在模板中通过${_env_key}方式引用': 'After the project-level variables are established, they can be referenced in the template through ${_env_key}',
    '值': 'Value',
    ...
    '个)': ' )',
    '管控区域': 'Control Area',
    '变量值是否带管控区域：': 'Value With Control Id: ',
    '异常': ' Abnormal',
    '移除': 'Remove',
    '正常': ' Normal',
