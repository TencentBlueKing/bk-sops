const en = {
    ...
    '跳过节点': 'Skip',
    '是否跳过该节点继续往后执行？': 'Is the execution of this task node skipped and continue?',
    '是否强制终止该节点？': 'Does it revoke to enforce this task node?',
    '是否完成该节点继续向后执行？': 'Does the completion of the task node continue backwards?',
    '备注': 'Description',
    ...
    '等方式引用全局变量。': 'to referencing global variables.',
    ...
    '复⽤参数值并使⽤流程最新数据重新执行': 'Reuse parameter values and re-execute using the latest data of the process',
    ...
    '若该变量被流程的节点引用，请及时检查并更新节点配置': 'If the variable is referenced by the node of the process, please check and update the node configuration in time',
    '确认删除该标签?': 'Are you sure you want to delete this label?',
