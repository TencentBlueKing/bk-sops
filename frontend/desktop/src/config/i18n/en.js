const en = {
    ...
    '以后再说': 'Later',
    '全局变量【 x 】的引用数已为 0。如果不再使用，可立即删除变量; 也可以稍后在全局变量面板中删除': 'The used count of the global variable [ x ] is already 0. The variable can be deleted directly; they can also be deleted later in the Global Variables Setting',
