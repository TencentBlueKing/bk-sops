const en = {
    ...
    //任务入参
    '任务入参': 'Input Parameters',
     //节点详情
    '查看节点详情': 'Task Detail',
    '执行记录': 'Execution Detail',
    ...
    '新建计划任务': 'New one-time scheduled task',
    '创建计划任务': 'New one-time scheduled task',
    '克隆计划任务': 'Clone one-time scheduled task',
    '编辑计划任务': 'Edit one-time scheduled task',
    '启动时间不能小于当前时间': 'Start time cannot be less than current time',
    '已执行的计划任务无法编辑': 'one-time scheduled tasks that have been executed cannot be edited',
    '创建计划任务成功': 'Created one-time scheduled task Successfully',
    '编辑计划任务成功': 'Edit  one-time scheduled task successfully',
    '删除计划任务成功': 'Delete  one-time scheduled task successfully',
    '克隆计划任务成功': 'Clone  one-time scheduled task successfully',
    '该计划任务已执行，请重新创建': 'The one-time scheduled task has been executed, please recreate',
    '如：2019-01-30 至 2019-02-30': 'Such as: 2019-01-30 to 2019-02-30',
    '任务实例': 'Task instance',
    '计划名称': 'Plan name',
    '执行参数': 'Execution params',
    '已选流程模板没有查看权限，请取消选择或申请权限': 'No view permission, please deselect or apply for permission',
    '已选流程模板没有编辑权限，请取消选择或申请权限': 'No edit permission, please deselect or apply for permission',
    ...
    '项目级别的变量建立后': 'After the project-level variables are created',
    '值': 'Value',
    ...
    '不允许添加没有节点的执行方案': 'It is not allowed to add step-group without nodes',
    ...
    '请选择节点的子流程': 'Please select the subflow of the node',
    '保存已修改的信息吗？': 'Save the modified information?',
    '已过期': 'Expired',
    '编辑执行方案': 'Edit Step Group',
    '确定保存流程并去设置执行方案？': 'Are you sure to save the flow and go to  step groups?',
    '确定保存克隆流程并去设置执行方案？': 'Are you sure to save clone flow and go to step groups?',
    ...
    '1.联系项目运维为您添加': '1.Contact project OPS to add ',
    '配置平台': 'CMDB',
    '对应项目的角色，如运维人员、开发人员、产品人员、测试人员': 'project roles like OPS, PM, DEV, tester',
    '2.联系项目运维为您添加需要操作的流程模板的权限': '2.Contact project OPS to add flow permissions for you',
    '3.或者前往': '3.Or goto ',
    ...
    '编辑轻应用': 'Edit Mini-APP',
    '应用名称': 'App Name',
    '当流程模板包含可选节点时，用户可以在新建任务时添加执行方案。这里选择执行方案后，创建的轻应用只能按照固定执行方案新建任务。': 'You can add step-group when creating a task if the flow contains optional nodes.After selecting a step-group, you can only create tasks according to the fixed step-group with this Mini-APP.',
    '如果轻应用选择了执行方案，更新模板后需要同步更新执行方案。': 'If the mini-app chooses the step-group, it needs to update the step-group synchronously after updating the flow.',
    '应用LOGO': 'LOGO',
    '点击更换': 'Change',
    ...
    '请输入执行人': 'Please Enter Executor',
    '请选择状态': 'Please Choose Status ',
    '未完成': 'Unfinished',
    '任务类型': 'Task types',
    '请输入更新人': 'Please Enter Editor',
    ...
    '确认删除轻应用？': 'Are you sure to delete this Mini-APP?',
    ...
    '请输入合法的函数': 'Enter valid function please',
    '请输入方法名称': 'Enter method name please',
    ...
    'API接口': 'API',
    '后台代码': 'Backend code',
    '请输入合法对象': 'Please Enter valid object',
    ...
    '认领': 'Take',
    '选择模板': 'Flow',
    '如果未找到模板，请联系项目运维在流程模板的使用权限中对你或所有职能化人员授予“新建任务权限”': "If there is no flow you want, please contact the OPS to add 'New Task' permission for you",
    '实时刷新': 'Refresh',
    '已驳回': 'Rejected',
    '选择类型': 'Select Type',
    '项': ' ',
    '请选择收藏项': 'Select a favorite please',
    ...
    '时区：': 'Timezone: ',
    '我的收藏': 'My Favorite',
    '确认删除收藏？': 'Are you sure to delete this item?',
    '常用流程到收藏夹，可作为你的流程管理快捷入口': 'frequently used flow to Favorites, so you can use them quickly',
    '我的动态': 'My Activity',
    '所有创建方式': 'All',
    '暂无数据': 'No data',
    '项目名称': 'Project Name',
    ...
    '？': '? ',
    '周期信息': 'Scheduled Info',
    '修改周期任务': 'Modify Scheduled Task',
    '周期规则': 'Crontab',
    '参数信息': 'Parameters',
    '图片出错': 'Rrror with image',
    '输入周期表达式非法，请校验': 'Invalid crontab, check it please',
    '修改周期任务信息成功': 'Modify scheduled task success',
    ...
    '修改周期任务失败，请联系管理员': 'Modify scheduled task failed, contact admin please',
    '修改周期任务表达式成功': 'Modify crontab success',
    '启动': 'Activate',
    '新建周期任务': 'New Scheduled Task',
    '上次运行时间': 'Last Run On',
    '运行次数': 'Number of Runs',
    ...
    '周期表达式': 'Crontab',
    '执行计划': 'step-group',
    '创建周期任务成功': 'Scheduled task created successfully',
    '执行方案列表': 'Step Groups',
    '方案名称': 'Step Group',
    '预览模式：': 'Preview:',
    '方案名称已存在': 'Group Name Repeated',
    '新增方案成功': 'Step Group Saved',
    '方案删除成功': 'Step Group Deleted',
    '取消全选': 'Cancel All',
    '节点选择': 'Selec Node t',
    ...
    '变量名称': 'Variable Name',
    '变量KEY': 'Variable KEY',
    '已存在相同KEY的变量，请新建变量': 'Key Repeated, please enter new key',
    ...
    '当前流程模板在浏览器多个标签页打开': 'Current flow opens in multiple browser tabs',
    '项目配置': 'Configure',
    ...
    '备注': 'Description',
    '模板级别的执行代理人会覆盖业务级别的执行代理人配置，': 'The flow-level executive agent will override the business-level executive agent configuration,',
    '若模板配置了执行代理人，业务的执行代理人白名单不会生效。': 'If the flow is configured with executive agent, the business executive agent whitelist will not take effect。',
    '仅支持本流程的执行代理，可在项目配置中': 'Only support the execution agent of this flow, can be in the project configuration',
    '设置项目执行代理人': 'set up project execution agent',
    '请输入流程模板备注信息': 'please enter flow description',
    '标签': 'Tags',
    '编辑标签': 'Edit Tag',
    ...
    '请输入流程模板名称': 'Please enter the flow name',
    '基础': 'Basic',
    '通知': 'Notify',
    '其他': 'Others',
    ...
    '个': '',
    '待更新的子流程': 'subpflow to be updated',
    '引擎版本': 'Engine Version',
    ...
    'API网关': 'API Gateway',
    '重置': 'Reset',
    '模板执行次数TOPx': 'TOP{x} flow execution times',
    ...
    '后': '',
    '则': '',
    '强制失败后跳过': 'Auto Skip after terminate',
    ...
    '每次创建任务会使用选中执行方案的最新版本且不会提示该节点需要更新': 'Each time a task is created, the latest version of the selected step-group is used and the node is not prompted for updates',
    '如果选中执行方案更新增加了新的变量，请打开对应的子流程节点进行填写；在不打开子流程节点进行填写的情况下，会使用变量默认值': 'If a new variable is added to the selected step-group update, please open the corresponding subflow node to fill in; if you do not open the subflow node to fill in, the default value of the variable will be used',
    ...
    '顶层流程（n）': 'Top Flow({n})',
    '子流程（n）': 'Sub Flow({n})',
    '是否覆盖已有子流程（实验功能，请谨慎使用并选择正确的流程）': 'Whether to override existing subflows (Experimental feature, please use it with caution and choose the correct flow)',
    ...
    '编辑周期任务': 'Edit Scheduled Task',
    '创建周期任务': 'Create Scheduled Task',
    '创建': 'Create',
    '通知方式统一在流程基础信息管理。如需修改，请': 'The notification method locate in the basic information management. To modify, please',
    '前往流程': 'go to flow',
    '旧版': 'Old',
    '返回编辑': 'Back To Edit',
    '周期任务根据创建时的流程和执行方案数据生成快照保存，流程变更后不影响周期任务，可手动更新到使用流程最新数据。': 'Scheduled tasks generate snapshots and save according to the flow and step-group data at the time of creation. After the flow is changed, it does not affect the scheduled tasks, and can be manually updated to use the latest version of the flow.',
    ...
    '计划任务在执行时获取最新的流程和执行方案数据创建任务，流程和方案变更将影响未执行的计划任务，如增加参数可能导致计划任务启动失败。': 'When a one-time scheduled task is executed, it get the latest version from the flow and step-group  to create a task. Changes to the flow and plan will affect the unexecuted one-time scheduled task. For example, adding parameters may cause the one-time scheduled task to fail to start.',
    ...
    '启动/暂停': 'Start/Pause',
    '已选节点': 'Selected node',
    '当前任务为旧数据，仅记录已选节点，强制更新后可选执行方案并获得提示更新能力': 'The current task is the old data, only the selected node is recorded, after the forced update, the step-group can be selected and the prompt update ability can be obtained',
    '已排除节点': 'Node excluded',
    '当前任务为旧数据，仅记录已排除节点，可重选执行方案获得跟随执行方案更新能力': 'The current task is the old data, only the excluded nodes are recorded, and the step-group can be reselected to obtain the ability to follow the step-group update',
    '无': 'None',
    '请选择执行方案': 'Please select an implementation plan',
    '旧数据计划任务克隆，不再记录已排除节点，请重选执行方案': 'The old data scheduled task is cloned, the excluded nodes are no longer recorded, please reselect the step-group',
    ...
    '以后再说': 'Tell you later',
    '全局变量【 x 】的引用数已为 0。如果不再使用，可立即删除变量; 也可以稍后在全局变量面板中删除': 'The used count of the global variable [ x ] is already 0. Variables can be deleted immediately if they are no longer used; they can also be deleted later in the Global Variables Setting',
    '取消变量豁免': 'Cancel variable exemption',
    '变量豁免': 'Variable exemption',
    '取消变量引用': 'Unused variable',
    '变量引用': 'Variable Used',
    ...
    '流程当前被使用中，无法删除': 'The flow is currently in use and cannot be deleted',
    ...
    '任务名': 'TaskName',
    'ID/任务名/创建人/执行人/状态/创建方式/执行代理人': 'ID/TaskName/Created by/Launched By/Status/Create Method/Executive Agent',
    'ID/任务名/创建人/更新人/状态': 'ID/TaskName/Created by/Modified By/Status',
    '应用名': 'AppName',
    '应用名/创建人': 'AppName/Created by',
    'ID/任务名/所属项目/提单人/认领人/认领状态/执行状态': 'ID/Task Name/Project/Created by/Claimant/Claim Status/Execution Status',
    'ID/任务名/所属项目/创建人/执行人/状态': 'ID/Task Name/Project/Created by/Launched By/Status',
    ...
    '不再支持周期任务使用公共流程，请使用项目流程': 'The scheduled tasks are no longer supported to use common flow, please use  flow',
    '常量': 'Constant',
    '必填': 'Required',
    '非必填': 'Not required',
    '执行时必填': 'Required for execution',
    '选中的执行方案被删除，请重新选择执行方案': 'The selected step-group is deleted, please re-select the step-group',
    ...
    '操作符两侧的比较对象支持通过 ${key} 或${int(key)} 等方式引用全局变量。': 'The comparison objects on both sides of the operator can use global variables,such as ${key} or ${int(key)}.',
    ...
    '拥有流程管理权限的人员，通过设置“执行代理人”功能，将流程任务的执行操作交由第三方人员（如：外包、外聘人员），帮助流程管理人员从繁重的执行工作中解放。': 'Person who owe the flow management permission can assign the execution of tasks to the helper team (such as outsourced, external personnel) by setting the "execution agent" , which helps the flow managers to be freed from heavy work.',
    ...
    'ID/任务名/执行人/状态': 'ID/Task Name/Launched By/Status',
    ...
    '打开此功能后，每次创建任务会尝试使用子流程的最新版本，并且不会再提示该节点需要更新。': 'When this feature is turned on, each task creation will try to use the latest version of the subflow and will no longer be prompted that the node needs to be updated.',
    ...
    '确认删除该标签?': 'Are you sure you want to delete this tag?',
    '关联的流程将同时移除本标签': 'The associated process will remove this label at the same time',
    '分组': 'group',
    '确定跳过当前节点?': 'Are you sure to skip the current node?',
    '跳过节点将忽略当前失败节点继续往后执行': 'Skip node will ignore the current failed node and continue to execute',
    '确定终止当前任务?': 'OK to terminate the current task?',
