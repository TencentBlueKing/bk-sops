const en = {
    ...
    '确定强制终止节点【n】': 'Force terminate this subflow [ {n} ] ？',
    ...
    '确定强制终止子流程【n】 ？': 'Force terminate this node [ {n} ] ？',
    '强制终止子流程将直接终止子流程发起的任务，终止后仅能重试或跳过子流程': 'Forced termination of sub-flows will directly terminate the sub-flow tasks, and the sub-flows will only be able to retry or skip',
    '子流程【n】已被强制终止': 'Subflow [ {n} ] Forced termination',
    '节点【n】已被强制终止': 'Node [ {n} ] Forced termination',
    '重新执行': 'Redo',
