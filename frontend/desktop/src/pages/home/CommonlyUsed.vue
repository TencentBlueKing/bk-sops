...
*/
<template>
    <div class="common-used" data-test-id="home-form-commonUsed" v-bkloading="{ isLoading: commonlyUsedloading, opacity: 1, zIndex: 100 }">
        <h3 class="panel-title">{{ $t('常用项目') }}</h3>
        <router-link :to="{ name: 'projectHome' }" data-test-id="home-form-allProject" class="link-btn">{{ $t('全部项目') }}</router-link>
