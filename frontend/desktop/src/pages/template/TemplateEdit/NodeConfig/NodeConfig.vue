    ...
    export default {
        ...
        data () {
            return {
                ...
                isPluginLoading: false, // 普通任务节点数据加载
        ...
        computed: {
            ...
            inputLoading () { // 以下任一方法处于 pending 状态，输入参数展示 loading 效果
                return this.isBaseInfoLoading || this.isPluginLoading || this.subflowLoading || this.constantsLoading || this.subflowVersionUpdating
            },
            outputLoading () {
                return this.isBaseInfoLoading || this.isPluginLoading || this.subflowLoading
            },
            selectorTitle () {
