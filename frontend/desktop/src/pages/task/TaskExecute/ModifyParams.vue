        ...
        <div class="action-wrapper">
            <div v-if="!isParamsEmpty && paramsCanBeModify">
                <bk-button
                    ...
                    data-test-id="taskExcute-form-saveMofifyParamsBtn"
                    @click="onModifyParams">
                    {{ $t('保存') }}
                </bk-button>
                <bk-button theme="default" data-test-id="taskExcute-form-cancelBtn" @click="onCancelRetry">{{ $t('取消') }}</bk-button>
            </div>
            
            <bk-button v-else theme="default" data-test-id="taskExcute-form-closeBtn" @click="onCancelRetry">{{ $t('关闭') }}</bk-button>
        </div>
