    ...
    <div class="parameter-details">
        ...
        <div
            ...
            <div class="scroll-area">
                ...
                <section class="info-section" data-test-id="taskExcute-from-operatFlow" v-if="executeInfo.id && location.type !== 'subflow'">
                ...
                <section class="info-section" data-test-id="taskExcute-from-outputParams" v-if="['tasknode', 'subflow'].includes(location.type)">
                ...
                <section class="info-section log-info" data-test-id="taskExcute-from-nodeLog">
