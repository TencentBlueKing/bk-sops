...
(function () {
    ...
    function () {
        ...
        var a = this,
                    ...
                    var f = function (b) {
                        ...
                        i = function (b) {
                            if (a.__tad && a.__tau && a.__tad[0] === a.__tau[0] && a.__tad[1] === a.__tau[1])
                                for (var c = 0; c < a.__taSmartClicks.length; c++) a.__taSmartClicks[c].apply(e(b), [b])
                        };
            ...
            E = function (a, b, c, d) {
                if (i(a, b, c), d.__tauid = c.__tauid, a.addEventListener) a.addEventListener(b, c, !1);
            ...
            F = function (a, b, c) {
                null != c && G(a, function () {
                    var e = d(this);
                    if (j(e, b, c), null != c.__tauid)
                        if (e.removeEventListener) e.removeEventListener(b, c, !1), s && u[b] && e.removeEventListener(u[b], c, !1);
                    ...
                    if (a.__ta)
                        for (var b in a.__ta)
                            if (a.__ta.hasOwnProperty(b))
                                for (var c in a.__ta[b]) a.__ta[b].hasOwnProperty(c) && F(a, b, a.__ta[b][c]);
    ...
    function () {
        ...
        var a = this,
            ...
            D = function (a, b, c) {
                ...
                var U = function (a, b) {
                    if (T[a])
                        for (var c = 0; c < T[a].length; c++) try {
                            T[a][c](b)
                        } catch (d) {
                        }
                };
    ...
    function () {
        ...
        var o = 0,
            ...
            q = b.jsPlumbInstance = function (f) {
                this.version = "2.2.10", f && r.extend(this.Defaults, f), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, d.EventGenerator.apply(this);
                var h = this,
                    i = p(),
                    j = h.bind,
                    l = {},
                ...
                this.unbindContainer = function () {
                    if (null != s && t.length > 0)
                        for (var a = 0; a < t.length; a++) h.off(s, t[a][0], t[a][1])
                ...
                var u = null,
                    ...
                    L = function (a, b, c, d) {
                        if (!F) {
                            ...
                            if (h.anchorManager.redraw(g, b, c, null, d), f)
                                for (var l in f) h.anchorManager.redraw(f[l].id, b, c, f[l].offset, d, !0)
                        }
                    },
                    M = function (a) {
                        return y[a]
                    ...
                    N = function (a, b, c, e, f) {
                        if (!r.headless) {
                            ...
                            if (g && r.isDragSupported(a, h)) {
                                ...
                                if (i = r.extend({}, i), r.isAlreadyDraggable(a, h)) c.force && h.initDraggable(a, i);
                                else {
                ...
                var $ = [{
                    ...
                    _ = function (a, b, c, d) {
                        ...
                        if (b.constructor == r.Endpoint) e = b, e.addConnection(a), b = e.element;
                        else if (f = Z(b), g = this[h.epDefs][f], f === a[h.elId]) e = null;
                        else if (g)
                            for (var l in g) {
                ...
                this.setSource = function (a, b, c) {
                    ...
                    for (var b in x) {
                        var c = x[b];
                        if (c && c.length)
                            for (var d = 0, e = c.length; e > d; d++) h.deleteEndpoint(c[d], !0)
                    }
                ...
                this.unregisterEndpoint = function (a) {
                    ...
                    if (0 !== arguments.length) {
                        ...
                        if (g) (f || d.functionChain(!0, !1, [
                            [g.endpoints[0], "isDetachAllowed", [g]],
                            [g.endpoints[1], "isDetachAllowed", [g]],
                            [g, "isDetachAllowed", [g]],
                            [h, "checkCondition", ["beforeDetach", g]]
                        ])) && g.endpoints[0].detach({
                            connection: g,
                            ignoreTarget: !1,
                            forceDetach: !0,
                            fireEvent: e,
                            ...
                            var j = r.extend({}, c);
                            if (j.uuids) M(j.uuids[0]).detachFrom(M(j.uuids[1]), e);
                            else if (j.sourceEndpoint && j.targetEndpoint) j.sourceEndpoint.detachFrom(j.targetEndpoint);
                            else {
                    ...
                    var c = Z(a),
                        d = x[c];
                    if (d && d.length)
                        for (var e = 0, f = d.length; f > e; e++) d[e].detachAll(b.fireEvent !== !1, b.forceDetach);
                    return h
                    ...
                    var b = {
                        ...
                        e = function (d) {
                            if (null != d && null == b.connections[d.id] && (a.dontUpdateHover || null == d._jsPlumb || d.setHover(!1), b.connections[d.id] = d, b.connectionCount++, c))
                                for (var e = 0; e < d.endpoints.length; e++) d.endpoints[e]._deleteOnDetach && f(d.endpoints[e])
                        },
                        f = function (d) {
                            if (null != d && null == b.endpoints[d.id] && (a.dontUpdateHover || null == d._jsPlumb || d.setHover(!1), b.endpoints[d.id] = d, b.endpointCount++, c))
                    ...
                    gb = function (a, b) {
                        ...
                        if (a)
                            if ("string" == typeof a) {
                                ...
                                for (var d = 0, e = a.length; e > d; d++) c.push(o(a[d]).id);
                            else c.push(o(a).id);
                        return c
                    },
                    hb = function (a, b, c) {
                ...
                this.init = function () {
                    ...
                    if (!b.jsPlumb.connectorsInitialized) {
                        for (var f = 0; f < c.length; f++)
                            for (var g = 0; g < a.length; g++) e(a[g], c[f][1], c[f][0]);
                    ...
                    if ("string" == typeof e) g = c(arguments[0], {
                        ...
                        if (d.isArray(e[0]) || d.isString(e[0])) 2 == e.length && d.isObject(e[1]) ? d.isString(e[0]) ? (a = b.jsPlumb.extend({
                            elementId: f,
                            jsPlumbInstance: h
                ...
                this.repaint = function (a, b, c) {
                    ...
                    var d = function (a) {
                        var e, f, g = o(a),
                            i = x[g.id];
                        if (i)
                            for (c.push(g), e = 0, f = i.length; f > e; e++) h.deleteEndpoint(i[e], !1);
                        if (delete x[g.id], b && g.el && 3 != g.el.nodeType && 8 != g.el.nodeType)
                            for (e = 0, f = g.el.childNodes.length; f > e; e++) d(g.el.childNodes[e])
                    };
                    return d(a), this
                };
                var Ab = function (a, b) {
        ...
        b.jsPlumb = r, r.getInstance = function (a, b) {
            ...
            if (null != a)
                if ("string" == typeof a) b(r.getElement(a));
                else if (null != a.length)
                    for (var c = 0; c < a.length; c++) b(r.getElement(a[c]));
                else b(a)
            ...
            var d = {},
                ...
                o = function (a, b, c, d, e, f) {
                    ...
                    for (var m = 0; m < i.length; m++)
                        for (var n = 0; n < i.length; n++) k.push({
                            source: i[m],
                            target: i[n],
        ...
        g.prototype = {
            ...
            this.computeMaxSize = function () {
                ...
                if (this.path = c, a.events)
                    for (var d in a.events) b.on(c, d, a.events[d])
                ...
                a.bind("connection", function (a) {
                    ...
                    if (b = this.getGroup(b)) {
                        ...
                        if (f !== b) {
                            ...
                            null != f && (f.remove(c, d), l.updateConnectionsForGroup(f)), b.add(c, d);
                            var i = function (a, c) {
                                var d = 0 == c ? 1 : 0;
                                a.each(function (a) {
                            ...
                            a.setPosition(c, k), a.dragManager.revalidateParent(c, j, g), l.updateConnectionsForGroup(b), setTimeout(function () {
                                a.fire(m, {
                                    group: b,
                                    el: c
                                })
        ...
        var a = this,
            ...
            d = function (a) {
                ...
                this._compute = function (a, b) {
                    ...
                    if (y)
                        for (var z = 0; z < y.length; z++) l(c, y[z][0], y[z][1], a);
