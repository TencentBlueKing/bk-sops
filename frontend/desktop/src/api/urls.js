...
export function getUrlSetting (SITE_URL, PROJECT_ID) {
    return {
        ...
        cc_search_top_set: SITE_URL + 'pipeline/cc_search_topo/set/normal/' + PROJECT_ID + '/',
        cc_search_top_resource: SITE_URL + 'pipeline/cc_search_topo/module/normal/' + PROJECT_ID + '/',
        cc_search_module: SITE_URL + 'pipeline/cc_search_module/' + PROJECT_ID + '/',
        cc_search_obj_attr: SITE_URL + 'pipeline/cc_search_object_attribute/host/' + PROJECT_ID + '/',
        cc_search_cols_attr: SITE_URL + 'pipeline/cc_search_create_object_attribute/set/' + PROJECT_ID + '/',
