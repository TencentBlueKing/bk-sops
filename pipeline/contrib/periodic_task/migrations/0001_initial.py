    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('args', models.TextField(default=b'[]', help_text='JSON encoded positional arguments', verbose_name='Arguments', blank=True)),
                ('kwargs', models.TextField(default=b'{}', help_text='JSON encoded keyword arguments', verbose_name='Keyword arguments', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.CharField(max_length=24, verbose_name='period', choices=[(b'days', 'Days'), (b'hours', 'Hours'), (b'minutes', 'Minutes'), (b'seconds', 'Seconds'), (b'microseconds', 'Microseconds')])),
            ],
            options={
