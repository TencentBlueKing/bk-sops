...
from pipeline.core.flow.io import IntItemSchema, StringItemSchema, ArrayItemSchema, ObjectItemSchema
...
class ObjectItemSchemaTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.array_schema = ArrayItemSchema(description=self.array_description,
                                            item_schema=StringItemSchema(description=self.array_item_description))
        self.inner_object_description = 'inner object'
        self.inner_object_schema = ObjectItemSchema(description=self.inner_object_description,
                                                    property_schemas={'int_key': self.int_schema,
    ...
    def test_as_dict(self):
        object_schema = ObjectItemSchema(description=self.description,
                                         property_schemas={
                                             ...
                                             'object_key': self.inner_object_schema
                                         })
