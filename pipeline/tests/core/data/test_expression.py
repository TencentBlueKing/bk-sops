...
class TestConstantTemplate(TestCase):
    ...
    def test_resolve_template(self):
        ...
        syntax_error = '${a.b}'
        self.assertRaises(exceptions.ConstantSyntaxException, cons_tmpl.resolve_template, syntax_error, {})
    ...
    def test_resolve(self):
        ...
        self.assertEqual(list_template.resolve({'a': 2, 'b': '3'}), ['2', ['2', '5']])

        tuple_template = expression.ConstantTemplate(('${a}', ('${a}', '${a+int(b)}')))
        self.assertEqual(tuple_template.resolve({'a': 2, 'b': '3'}), ('2', ('2', '5')))

        dict_template = expression.ConstantTemplate({'aaaa': {'a': '${a}', 'b': '${a+int(b)}'}})
        self.assertEqual(dict_template.resolve({'a': 2, 'b': '3'}), {'aaaa': {'a': '2', 'b': '5'}})
