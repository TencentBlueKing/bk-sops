...
def flow_valid_case(testcase):
    ...
    pgs.append(ConditionalParallelGateway(id=parallel_gw_id(3), conditions={
        0: '123',
        1: '456',
        2: '789',
    }))
    egs = [ExclusiveGateway(id=exclusive_gw_id(i), conditions={
        0: '123',
        1: '456',
        2: '789',
        3: '101112'
    ...
    pgs[_(2)].connect(
        ...
        acts[_(3)],
        acts[_(4)]
    ).converge(cgs[_(1)]).extend(acts[_(7)]).extend(egs[_(1)]).connect(
        pgs[_(2)],
        cgs[_(3)]
    )
    acts[_(5)].extend(egs[_(7)]).connect(
        cgs[_(3)],
        acts[_(8)]
    ).to(acts[_(8)]).extend(egs[_(8)]).connect(
        acts[_(8)],
        acts[_(11)]
    ...
    acts[_(14)].extend(egs[_(4)]).connect(
        acts[_(13)],
        cgs[_(4)]
    )
    pgs[_(3)].connect(
    ...
    for node in nodes:
        ...
        testcase.assertEqual(a['outgoing'], out,
                             msg='{id} actual: {a}, expect: {e}'.format(id=node.id, a=out, e=a['outgoing']))
...
def flow_valid_edge_case_2():
    return {
        'activities': {
            'act_1': {'component': {'inputs': {}, 'code': None}, 'outgoing': '82b12b6aae533e55bdcc5bccfb014c2d',
                      'incoming': ['3fc89273786a36b8a6e7beac8301274d'], 'name': None, 'error_ignorable': False,
                      'type': 'ServiceActivity', 'id': 'act_1', 'optional': False},
            'act_2': {'component': {'inputs': {}, 'code': None}, 'outgoing': '3368add44347310eaef1f26f25909026',
                      'incoming': ['76caeed0e6053fea9db84a89f56a74a8'], 'name': None, 'error_ignorable': False,
                      'type': 'ServiceActivity', 'id': 'act_2', 'optional': False}},
        'end_event': {'type': 'EmptyEndEvent', 'outgoing': '', 'incoming': ['05f91b45a15b37d7b0c96d3ff94bff80'],
                      'id': 'end_event_id', 'name': None},
        'flows': {
            '27a9cdeaef623d37834ac6917d05eac5': {'is_default': False, 'source': 'start_event_id', 'target': 'pg_1',
                                                 'id': '27a9cdeaef623d37834ac6917d05eac5'},
            '82b12b6aae533e55bdcc5bccfb014c2d': {'is_default': False, 'source': 'act_1', 'target': 'cg_1',
                                                 'id': '82b12b6aae533e55bdcc5bccfb014c2d'},
            '3368add44347310eaef1f26f25909026': {'is_default': False, 'source': 'act_2', 'target': 'cg_1',
                                                 'id': '3368add44347310eaef1f26f25909026'},
            '05f91b45a15b37d7b0c96d3ff94bff80': {'is_default': False, 'source': 'cg_1', 'target': 'end_event_id',
                                                 'id': '05f91b45a15b37d7b0c96d3ff94bff80'},
            '3fc89273786a36b8a6e7beac8301274d': {'is_default': False, 'source': 'pg_1', 'target': 'act_1',
                                                 'id': '3fc89273786a36b8a6e7beac8301274d'},
            '76caeed0e6053fea9db84a89f56a74a8': {'is_default': False, 'source': 'pg_1', 'target': 'act_2',
                                                 'id': '76caeed0e6053fea9db84a89f56a74a8'},
            '76casdgd0e6053ea9db84a89f56a1234': {'is_default': False, 'source': 'pg_1', 'target': 'cg_1',
                                                 'id': '76caeed0e6053fea9db84a89f56a74a8'}},
        'gateways': {
            'cg_1': {'type': 'ConvergeGateway', 'outgoing': '05f91b45a15b37d7b0c96d3ff94bff80',
                     'incoming': ['82b12b6aae533e55bdcc5bccfb014c2d',
                                  '3368add44347310eaef1f26f25909026',
                                  '76casdgd0e6053ea9db84a89f56a1234'], 'id': 'cg_1',
                     'name': None},
            'pg_1': {'outgoing': ['3fc89273786a36b8a6e7beac8301274d',
                                  '76caeed0e6053fea9db84a89f56a74a8',
                                  '76casdgd0e6053ea9db84a89f56a1234'],
                     'incoming': ['27a9cdeaef623d37834ac6917d05eac5'], 'name': None, 'converge_gateway_id': 'cg_1',
                     'type': 'ParallelGateway', 'id': 'pg_1'}},
        'start_event': {'type': 'EmptyStartEvent', 'outgoing': '27a9cdeaef623d37834ac6917d05eac5', 'incoming': '',
                        'id': 'start_event_id', 'name': None}, 'data': {'inputs': {}, 'outputs': {}},
...
def flow_invalid_case_2():
    ...
    start.extend(act_1).extend(eg).connect(
        act_3,
        act_2
    ).to(act_2).extend(pg).connect(
        act_3,
        act_4
...
flow_invalid_cases = [
    {
        'case': flow_invalid_case_1,
        'assert_invalid': act_id(3)
    },
    {
        'case': flow_invalid_case_2,
        'assert_invalid': act_id(3)
    }
]
...
gateway_invalid_cases = [
    {
        'case': gateway_invalid_case_1,
        'invalid_assert': exclusive_gw_id(1)
    },
    {
        'case': gateway_invalid_case_2,
        'invalid_assert': converge_gw_id(1)
    },
    {
        'case': gateway_invalid_case_3,
        'invalid_assert': exclusive_gw_id(1)
    },
    {
        'case': gateway_invalid_case_4,
        'invalid_assert': parallel_gw_id(1)
    },
    {
        'case': gateway_invalid_case_5,
        'invalid_assert': parallel_gw_id(1)
    },
    {
        'case': gateway_invalid_case_6,
        'invalid_assert': exclusive_gw_id(1)
    },
    {
        'case': gateway_invalid_case_7,
        'invalid_assert': parallel_gw_id(2)
    },
    {
        'case': gateway_invalid_case_8,
        'invalid_assert': parallel_gw_id(1)
    }
]
