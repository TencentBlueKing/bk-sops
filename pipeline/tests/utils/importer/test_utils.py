...
class UtilsTestCase(TestCase):
    ...
    def test__remove_importer(self):
        importer_1 = GitRepoModuleImporter(modules=['module_1'], repo_raw_url='url_1', branch='master')
        importer_2 = GitRepoModuleImporter(modules=['module_2'], repo_raw_url='url_2', branch='master')
        importer_3 = GitRepoModuleImporter(modules=['module_3'], repo_raw_url='url_3', branch='master')
        importer_4 = GitRepoModuleImporter(modules=['module_4'], repo_raw_url='url_4', branch='master')
