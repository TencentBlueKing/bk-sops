...
from pipeline.validators import constants
...
def post_new_end_event_register_handler(sender, node_type, node_cls, **kwargs):
    constants.ACTIVITY_RULES[node_type] = constants.END_EVENT_RULE
    constants.FLOW_NODES_WITHOUT_STARTEVENT.append(node_type)
