    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='\u9ed8\u8ba4\u5b9e\u4f8b', max_length=64, verbose_name='\u5b9e\u4f8b\u540d\u79f0')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='\u9ed8\u8ba4\u6a21\u677f', max_length=64, verbose_name='\u6a21\u677f\u540d\u79f0')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('creator', models.CharField(max_length=32, verbose_name='\u521b\u5efa\u8005')),
                ('description', models.TextField(blank=True, null=True, verbose_name='\u63cf\u8ff0')),
        ...
        migrations.AddField(
            ...
            name='snapshot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pipeline.Snapshot', verbose_name='\u6a21\u677f\u7ed3\u6784\u6570\u636e'),
        ),
        migrations.AddField(
            model_name='pipelineinstance',
            name='execution_snapshot',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='execution_snapshot', to='pipeline.Snapshot', verbose_name='\u7528\u4e8e\u5b9e\u4f8b\u6267\u884c\u7684\u7ed3\u6784\u6570\u636e'),
        ),
        migrations.AddField(
            model_name='pipelineinstance',
            name='snapshot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='snapshot', to='pipeline.Snapshot', verbose_name='\u5b9e\u4f8b\u7ed3\u6784\u6570\u636e'),
        ),
        migrations.AddField(
            model_name='pipelineinstance',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pipeline.PipelineTemplate', verbose_name='Pipeline\u6a21\u677f'),
        ),
    ]
