# -*- coding: utf-8 -*-
"""
Tencent is pleased to support the open source community by making 蓝鲸智云PaaS平台社区版 (BlueKing PaaS Community Edition) 
available.
...
user_info = importlib.import_module('bk_api.sites.%s.user_info' % settings.RUN_VER)
