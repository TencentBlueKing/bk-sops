![](https://github.com/TencentBlueKing/bk-sops/blob/master/docs/zh_hans/img/wiki_sops.png)
...
![](https://github.com/TencentBlueKing/bk-sops/blob/master/docs/zh_hans/img/wiki_product.png)

## 功能特性
![](https://github.com/TencentBlueKing/bk-sops/blob/master/docs/zh_hans/img/wiki_feature.png)
...
![](https://github.com/TencentBlueKing/bk-sops/blob/master/docs/zh_hans/img/wiki_future.png)

## 关于开源协议
标准运维采用的是MIT开源协议。MIT是和BSD一样宽范的许可协议，作者只想保留版权，而无任何其他的限制。使用者必须在发行版里包含原许可协议的声明，无论是以二进制发布的还是以源代码发布的。

## 欢迎一起交流
![](https://github.com/TencentBlueKing/bk-sops/blob/master/docs/zh_hans/img/wiki_communication.png)
...
腾讯蓝鲸体系产品架构图-社区版  
![](https://github.com/TencentBlueKing/bk-sops/blob/master/docs/zh_hans/img/wiki_blueking.png)
...
开源产品链接  
标准运维：https://github.com/TencentBlueKing/bk-sops  
PaaS平台：https://github.com/TencentBlueKing/bk-paas  
配置平台：https://github.com/TencentBlueKing/bk-cmdb  
容器管理平台：https://github.com/TencentBlueKing/bk-bcs  
