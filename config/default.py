...
ENABLE_CLEAN_EXPIRED_TASKS = env.ENABLE_CLEAN_EXPIRED_TASKS
CLEAN_EXPIRED_TASK_DATA_CRON = env.CLEAN_EXPIRED_TASK_DATA_CRON
CLEAN_EXPIRED_TASK_BATCH_NUM = env.CLEAN_EXPIRED_TASK_BATCH_NUM
CLEAN_TASK_MAX_ID = env.CLEAN_TASK_MAX_ID
