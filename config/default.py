...
# 第三方插件调用超时时间
REMOTE_PLUGIN_INVOKE_TIMEOUT = env.REMOTE_PLUGIN_INVOKE_TIMEOUT
REMOTE_PLUGIN_DETAIL_TIMEOUT = env.REMOTE_PLUGIN_DETAIL_TIMEOUT
REMOTE_PLUGIN_SCHEDULE_TIMEOUT = env.REMOTE_PLUGIN_SCHEDULE_TIMEOUT
