...
CLEAN_EXPIRED_V2_TASK_DATA_CONFIG = env.CLEAN_EXPIRED_V2_TASK_DATA_CONFIG
...
SYNC_INCREMENTAL_DATA_SWITCH = env.SYNC_INCREMENTAL_DATA_SWITCH

SYNC_INCREMENTAL_DATA_CRON = env.SYNC_INCREMENTAL_DATA_CRON
SYNC_INCREMENTAL_BATCH_SIZE = env.SYNC_INCREMENTAL_BATCH_SIZE

SYNC_SOURCE_HOST = env.SYNC_SOURCE_HOST
SYNC_SOURCE_PORT = env.SYNC_SOURCE_PORT
SYNC_SOURCE_USER = env.SYNC_SOURCE_USER
SYNC_SOURCE_PASSWORD = env.SYNC_SOURCE_PASSWORD
SYNC_SOURCE_DATABASE = env.SYNC_SOURCE_DATABASE
