...
# APIGW AI 平台标识 HTTP Header 配置
APIGW_AI_PLATFORM_HEADER = env.APIGW_AI_PLATFORM_HEADER

# APIGW AI 技能名称 HTTP Header 配置
APIGW_AI_SKILL_HEADER = env.APIGW_AI_SKILL_HEADER
